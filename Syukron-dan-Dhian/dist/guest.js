(()=>{var K=(()=>{let n=null,t=null,e=0,r=0,s=!0,o=!1,a=null,u=()=>{e+=1},h=()=>`(${r}/${e}) [${parseInt(r/e*100).toFixed(0)}%]`;return{init:()=>{n=document.getElementById("progress-info"),t=document.getElementById("progress-bar"),n.classList.remove("d-none"),a=new Promise(I=>document.addEventListener("undangan.progress.invalid",I))},add:u,invalid:I=>{s&&!o&&(s=!1,t.style.backgroundColor="red",n.innerText=`Error loading ${I} ${h()}`,document.dispatchEvent(new Event("undangan.progress.invalid")))},complete:(I,S=!1)=>{s&&(r+=1,n.innerText=`Loading ${I} ${S?"skipped":"complete"} ${h()}`,t.style.width=Math.min(r/e*100,100).toString()+"%",r===e&&(o=!0,document.dispatchEvent(new Event("undangan.progress.done"))))},getAbort:()=>a}})();var X=(()=>{let n='<span class="spinner-border spinner-border-sm my-0 ms-0 me-1 p-0" style="height: 0.8rem; width: 0.8rem;"></span>',t=[["*",'<strong class="text-theme-auto">$1</strong>'],["_",'<em class="text-theme-auto">$1</em>'],["~",'<del class="text-theme-auto">$1</del>'],["```",'<code class="font-monospace text-theme-auto">$1</code>']],e=[{type:"Mobile",regex:/Android.*Mobile|iPhone|iPod|BlackBerry|IEMobile|Opera Mini/i},{type:"Tablet",regex:/iPad|Android(?!.*Mobile)|Tablet/i},{type:"Desktop",regex:/Windows NT|Macintosh|Linux/i}],r=[{name:"Chrome",regex:/Chrome|CriOS/i},{name:"Safari",regex:/Safari/i},{name:"Edge",regex:/Edg|Edge/i},{name:"Firefox",regex:/Firefox|FxiOS/i},{name:"Opera",regex:/Opera|OPR/i},{name:"Internet Explorer",regex:/MSIE|Trident/i},{name:"Samsung Browser",regex:/SamsungBrowser/i}],s=[{name:"Windows",regex:/Windows NT ([\d.]+)/i},{name:"MacOS",regex:/Mac OS X ([\d_.]+)/i},{name:"Android",regex:/Android ([\d.]+)/i},{name:"iOS",regex:/OS ([\d_]+) like Mac OS X/i},{name:"Linux",regex:/Linux/i},{name:"Ubuntu",regex:/Ubuntu/i},{name:"Chrome OS",regex:/CrOS/i}],o=V=>String(V).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"),a=V=>{let O=F=>{window.alert(`${F} ${V}`)};return{success:()=>O("\u{1F7E9}"),error:()=>O("\u{1F7E5}"),warning:()=>O("\u{1F7E8}"),info:()=>O("\u{1F7E6}"),custom:F=>O(F)}},u=V=>window.confirm(`\u{1F7E6} ${V}`),h=(V,O)=>(V.replaceChildren(document.createRange().createContextualFragment(O)),V),d=(V,O,F=.05)=>new Promise(v=>{let p=parseFloat(V.style.opacity),y=O?1:0,E=()=>{p+=O?F:-F,p=Math.max(0,Math.min(1,p)),V.style.opacity=p.toFixed(2),O&&p>=y||!O&&p<=y?(V.style.opacity=y.toString(),v(V)):requestAnimationFrame(E)};requestAnimationFrame(E)}),m=(V,O=0)=>{let F=null;F=setTimeout(()=>{V(),clearTimeout(F),F=null},O)};return{loader:n,ask:u,copy:async(V,O=null,F=1500)=>{let v=V.getAttribute("data-copy");if(!v||v.length===0){a("Nothing to copy").warning();return}V.disabled=!0;try{await navigator.clipboard.writeText(v)}catch(y){console.error("Clipboard error:",y),V.disabled=!1,a("Failed to copy").error();return}let p=V.innerHTML;h(V,O||'<p class="fw-bold m-0"><i class="fa-solid fa-check"></i> Success</p>'),m(()=>{V.disabled=!1,V.innerHTML=p},F)},notify:a,timeOut:m,debounce:(V,O=100)=>{let F=null;return(...v)=>{clearTimeout(F),F=setTimeout(()=>V(...v),O)}},escapeHtml:o,base64Encode:V=>{let F=new TextEncoder().encode(V);return window.btoa(String.fromCharCode(...F))},base64Decode:V=>{let O=new TextDecoder,F=Uint8Array.from(window.atob(V),v=>v.charCodeAt(0));return O.decode(F)},disableButton:(V,O="Loading",F=!1)=>{V.disabled=!0;let v=V.innerHTML;return h(V,F?O:n+O),{restore:(p=!1)=>{V.innerHTML=v,V.disabled=p}}},disableCheckbox:V=>{V.disabled=!0;let O=document.querySelector(`label[for="${V.id}"]`),F=O.innerHTML;return h(O,n+F),{restore:()=>{O.innerHTML=F,V.disabled=!1}}},safeInnerHTML:h,parseUserAgent:V=>{if(!V||typeof V!="string")return"Unknown";let O=e.find(E=>E.regex.test(V))?.type??"Unknown",F=r.find(E=>E.regex.test(V))?.name??"Unknown",v=s.find(E=>E.regex.test(V)),p=v?v.name:"Unknown",y=v?V.match(v.regex)?.[1]?.replace(/_/g,".")??null:null;return`${F} ${O} ${y?`${p} ${y}`:p}`},changeOpacity:d,getGMTOffset:V=>{let O=new Date,F=new Intl.DateTimeFormat("en-US",{timeZone:V,hourCycle:"h23",hour:"numeric"}),v=(parseInt(F.format(O))-O.getUTCHours()+24)%24;return v>12&&(v-=24),`GMT${v>=0?"+":""}${v}`},convertMarkdownToHTML:V=>(t.forEach(([O,F])=>{V=V.replace(new RegExp(`\\${O}(\\S(?:[\\s\\S]*?\\S)?)\\${O}`,"g"),F)}),V)}})();var Nt="GET";var Gc="POST";var zc="AbortError",zd="TypeError",$c={Accept:"application/json","Content-Type":"application/json"},$d="request",Gd=(()=>{let n=null;return{getInstance:()=>(n||(n=window.caches.open($d)),n),purge:()=>{n=null}}})();var On=n=>({set:(s,o,a,u)=>o.clone().arrayBuffer().then(h=>{if(!o.ok||!window.isSecureContext)return o;let d=new Date,m=new Headers(o.headers);if(m.has("Date")||m.set("Date",d.toUTCString()),a||!m.has("Cache-Control")){if(!a&&m.has("Expires")){let g=new Date(m.get("Expires"));u=Math.max(0,g.getTime()-d.getTime())}m.set("Cache-Control",`public, max-age=${Math.floor(u/1e3)}`)}return m.has("Content-Length")||m.set("Content-Length",String(h.byteLength)),n.put(s,new Response(h,{headers:m})).then(()=>o)}),has:s=>n.match(s).then(o=>{if(!o)return null;let a=o.headers.get("Cache-Control").match(/max-age=(\d+)/)[1],u=Date.parse(o.headers.get("Date"))+parseInt(a)*1e3;return Date.now()>u?null:o}),del:s=>n.delete(s)}),jt=(n,t)=>{let e=new AbortController,r={signal:e.signal,credential:"include",headers:new Headers($c),method:String(n).toUpperCase()};window.addEventListener("offline",()=>e.abort(),{once:!0}),window.addEventListener("popstate",()=>e.abort(),{once:!0});let s=0,o=0,a=0,u=0,h=!1,d=null,m=null,g=null,_=S=>{let D=()=>{let P=()=>window.fetch(S,r).then(async R=>{if(!R.ok||!g)return R;let M=parseInt(R.headers.get("Content-Length")??0);if(M===0)return R;let V=[],O=0,F=R.body.getReader();for(;;){let{done:p,value:y}=await F.read();if(p)break;V.push(y),O+=y.length,await g(O,M,window.structuredClone?window.structuredClone(V):V)}let v=R.headers.get("Content-Type")??"application/octet-stream";return new Response(new Blob(V,{type:v}),{status:R.status,statusText:R.statusText,headers:new Headers(R.headers)})});return s===0||!window.isSecureContext?P():r.method!==Nt?(console.warn("Only method GET can be cached"),P()):Gd.getInstance().then(On).then(R=>R.has(S).then(M=>M?Promise.resolve(M):R.del(S).then(P).then(V=>R.set(S,V,h,s))))};if(o===0&&a===0)return D();let x=async()=>{try{return await D()}catch(P){if(P.name===zc)throw P;if(a*=2,u++,u>o)throw new Error(`Max retries reached: ${P}`);return console.warn(`Retrying fetch (${u}/${o}): ${S.toString()}`),await new Promise(R=>window.setTimeout(R,a)),x()}};return x()},I=S=>{if(S.status!==200)return S;let D=document.querySelector("a[download]");D&&document.body.removeChild(D);let x=S.headers.get("Content-Disposition")?.match(/filename="(.+)"/)?.[1];return S.clone().blob().then(P=>{let R=document.createElement("a"),M=window.URL.createObjectURL(P);return R.href=M,R.download=x||`${m}.${d||(P.type.split("/")?.[1]??"bin")}`,document.body.appendChild(R),R.click(),document.body.removeChild(R),window.URL.revokeObjectURL(M),S})};return{send(S=null){return m&&Object.keys($c).forEach(D=>r.headers.delete(D)),_(new URL(t,document.body.getAttribute("data-url"))).then(D=>m&&D.ok?{code:D.status,data:I(D),error:null}:D.json().then(x=>{if(x.error){let P=x.error.at(0),R=D.status>=500;throw new Error(R?`ID: ${x.id}
\u{1F7E5} ${P}`:`\u{1F7E8} ${P}`)}return S&&(x.data=S(x.data)),Object.assign(x,{code:D.status})})).catch(D=>{if(D.name===zc)return console.warn("Fetch aborted:",D),D;throw D.name===zd&&(D=new Error("\u{1F7E5} Network error or rate limit exceeded")),alert(D.message??String(D)),D})},withCache(S=1e3*60*60*6){return s=S,this},withForceCache(){return h=!0,this},withRetry(S=3,D=1e3){return o=S,a=D,this},withCancel(S){return S==null?this:((async()=>(await S,e.abort()))(),this)},withDownload(S,D=null){return m=S,d=D,this},withProgressFunc(S=null){return g=S,this},default(S=null){return r.headers=new Headers(S??{}),_(t).then(D=>m?I(D):D)},token(S){return S.split(".").length===3?(r.headers.append("Authorization","Bearer "+S),this):(r.headers.append("x-access-key",S),this)},body(S){if(r.method===Nt)throw new Error("GET method does not support body");return r.body=JSON.stringify(S),this}}};var Kd=(()=>{let n=null;return{getInstance:t=>(n||(n=new Map),n.has(t)||n.set(t,window.caches.open(t)),n.get(t))}})(),ie=n=>{let t=new Map,e=new Map,r=null,s=1e3*60*60*6,o=!1,a=async()=>(!r&&window.isSecureContext&&(r=await Kd.getInstance(n)),r),u=(I,S)=>a().then(On).then(D=>{if(!S.ok)throw new Error(S.statusText);return D.set(I,S,o,s)}),h=I=>a().then(On).then(S=>S.has(I)),d=I=>a().then(On).then(S=>S.del(I)),m=(I,S=null)=>{if(t.has(I))return Promise.resolve(t.get(I));if(e.has(I))return e.get(I);let D=()=>jt(Nt,I).withCancel(S).withRetry().default(),x=a().then(()=>window.isSecureContext?h(I).then(P=>P?Promise.resolve(P):d(I).then(D).then(R=>u(I,R))):D()).then(P=>P.blob()).then(P=>t.set(I,URL.createObjectURL(P))).then(()=>t.get(I)).finally(()=>e.delete(I));return e.set(I,x),x};return{run:(I,S=null)=>a().then(()=>{let D=new Map;return window.isSecureContext||console.warn("Cache is not supported in insecure context"),I.filter(x=>x!==null).forEach(x=>{let P=D.get(x.url)??[];D.set(x.url,[...P,[x.res,x?.rej]])}),Promise.allSettled(Array.from(D).map(([x,P])=>m(x,S).then(R=>(P.forEach(M=>M[0]?.(R)),R)).catch(R=>(P.forEach(M=>M[1]?.(R)),R))))}),del:d,has:h,set:u,get:m,open:a,download:async(I,S)=>{if(!new Map(Array.from(t.entries()).map(([x,P])=>[P,x])).has(I))try{if(!new URL(I).protocol.includes("blob"))throw new Error("Is not blob")}catch{I=await m(I)}return jt(Nt,I).withDownload(S).default()},setTtl(I){return s=Number(I),this},withForceCache(){return o=!0,this}}};var Kc=(()=>{let n=null,t=()=>{let r=document.getElementById("video-love-stroy");if(!r||!r.hasAttribute("data-src"))return r?.remove(),K.complete("video",!0),Promise.resolve();let s=r.getAttribute("data-src");if(!s)return K.complete("video",!0),Promise.resolve();let o=document.createElement("video");o.className=r.getAttribute("data-vid-class"),o.loop=!0,o.muted=!0,o.controls=!0,o.autoplay=!1,o.playsInline=!0,o.preload="metadata",o.disableRemotePlayback=!0,o.disablePictureInPicture=!0,o.controlsList="noremoteplayback nodownload noplaybackrate";let a=new IntersectionObserver(d=>d.forEach(m=>m.isIntersecting?o.play():o.pause())),u=d=>(o.addEventListener("loadedmetadata",()=>{o.style.removeProperty("height"),document.getElementById("video-love-stroy-loading")?.remove()},{once:!0}),d.clone().blob().then(m=>(o.src=URL.createObjectURL(m),d))),h=()=>{let d=document.getElementById("progress-bar-video-love-stroy"),m=document.getElementById("progress-info-video-love-stroy");return jt(Nt,s).withCancel(new Promise(g=>o.addEventListener("undangan.video.prefetch",g,{once:!0}))).default({Range:"bytes=0-1"}).then(g=>{if(o.dispatchEvent(new Event("undangan.video.prefetch")),g.status===200)return o.preload="none",o.src=X.escapeHtml(s),r.appendChild(o),Promise.resolve();if(g.status!==206)throw new Error("failed to fetch video");o.addEventListener("error",()=>K.invalid("video"),{once:!0});let _=new Promise(I=>o.addEventListener("loadedmetadata",I,{once:!0}));return o.src=X.escapeHtml(s),r.appendChild(o),_}).then(()=>{K.complete("video");let g=o.getBoundingClientRect().width*(o.videoHeight/o.videoWidth);return o.style.height=`${g}px`,jt(Nt,o.src).withProgressFunc((_,I)=>{let S=Number(_/I*100).toFixed(0)+"%";d.style.width=S,m.innerText=S}).withRetry().default().then(u).catch(_=>{d.style.backgroundColor="red",m.innerText="Error loading video",console.error(_)}).finally(()=>a.observe(o))})};return window.isSecureContext?n.has(s).then(d=>d?(K.complete("video"),u(d).finally(()=>{r.appendChild(o),a.observe(o)})):n.del(s).then(h).then(m=>n.set(s,m))):h()};return{init:()=>(K.add(),n=ie("video").withForceCache(),{load:t})}})();var Hc=(()=>{let n=null,t=null,e=!1,r=[],s=_=>new Promise((I,S)=>{let D=new Image;D.onload=()=>I(D),D.onerror=S,D.src=_}),o=(_,I)=>new Promise((S,D)=>{let x=new Image;x.src=I,x.onload=()=>{x.decode?x.decode().then(()=>{_.width=x.naturalWidth,_.height=x.naturalHeight,_.src=x.src,K.complete("image"),S()}).catch(P=>{console.warn("decode gagal, fallback ke onload biasa",P),_.width=x.naturalWidth,_.height=x.naturalHeight,_.src=x.src,K.complete("image"),S()}):(_.width=x.naturalWidth,_.height=x.naturalHeight,_.src=x.src,K.complete("image"),S())},x.onerror=P=>{console.error("Image load error:",P),K.invalid("image"),D(P)}}),a=_=>{r.push({url:_.getAttribute("data-src"),res:I=>o(_,I),rej:I=>{console.error(I),K.invalid("image")}})},u=_=>{_.onerror=()=>K.invalid("image"),_.onload=()=>{_.width=_.naturalWidth,_.height=_.naturalHeight,K.complete("image")},_.complete&&_.naturalWidth!==0&&_.naturalHeight!==0?K.complete("image"):_.complete&&K.invalid("image")},h=()=>e,d=async()=>{let _=Array.from(n);_.filter(I=>I.getAttribute("data-fetch-img")!=="high").forEach(I=>{I.hasAttribute("data-src")?a(I):u(I)}),e&&(await t.open(),await Promise.allSettled(_.filter(I=>I.getAttribute("data-fetch-img")==="high").map(I=>t.get(I.getAttribute("data-src"),K.getAbort()).then(S=>o(I,S)).then(()=>I.classList.remove("opacity-0")))),await t.run(r,K.getAbort()))},m=_=>t.download(_,`image_${Date.now()}`);return{init:()=>(t=ie("image").withForceCache(),n=document.querySelectorAll("img"),n.forEach(K.add),e=Array.from(n).some(_=>_.hasAttribute("data-src")),{load:d,download:m,hasDataSrc:h})}})();var Wc=(()=>{let n='<i class="fa-solid fa-microphone-lines fa-2x spin-button"></i>',t='<i class="fa-solid fa-microphone-lines-slash fa-2x"></i>',e=async(s=!0)=>{let o=document.body.getAttribute("data-audio");if(!o){K.complete("audio",!0);return}let a=null;try{a=new Audio(await ie("audio").withForceCache().get(o,K.getAbort())),a.loop=!0,a.muted=!1,a.autoplay=!1,a.controls=!1,K.complete("audio")}catch{K.invalid("audio");return}let u=!1,h=document.getElementById("button-music"),d=async()=>{if(!(!navigator.onLine||!h)){h.disabled=!0;try{await a.play(),u=!0,h.disabled=!1,h.innerHTML=n}catch(g){u=!1,X.notify(g).error()}}},m=()=>{u=!1,a.pause(),h.innerHTML=t};document.addEventListener("undangan.open",()=>{h.classList.remove("d-none"),s&&d()}),h.addEventListener("offline",m),h.addEventListener("click",()=>u?m():d())};return{init:()=>(K.add(),{load:e})}})();var Qc={tab:e=>window.bootstrap.Tab.getOrCreateInstance(document.getElementById(e)),modal:e=>window.bootstrap.Modal.getOrCreateInstance(document.getElementById(e))};var Wd="https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.css",Qd="https://cdn.jsdelivr.net/npm/aos@2.3.4/dist/aos.js",Jd="https://cdn.jsdelivr.net/npm/canvas-confetti@1.9.3/dist/confetti.browser.js",Xd=n=>{let t=()=>n.get(Wd).then(r=>new Promise((s,o)=>{let a=document.createElement("link");a.onload=s,a.onerror=o,a.rel="stylesheet",a.href=r,document.head.appendChild(a)})),e=()=>n.get(Qd).then(r=>new Promise((s,o)=>{let a=document.createElement("script");a.onload=s,a.onerror=o,a.src=r,document.head.appendChild(a)}));return Promise.all([t(),e()]).then(()=>{if(typeof window.AOS>"u")throw new Error("AOS library failed to load");window.AOS.init()})},Yd=n=>n.get(Jd).then(t=>new Promise((e,r)=>{let s=document.createElement("script");s.onerror=r,s.onload=()=>{typeof window.confetti>"u"?r(new Error("Confetti library failed to load")):e()},s.src=t,document.head.appendChild(s)})),Jc=(n={})=>{let t=ie("libs");return t.open().then(()=>{let e=[];return(n?.aos??!0)&&e.push(Xd(t)),(n?.confetti??!0)&&e.push(Yd(t)),Promise.all(e)})};var bt=n=>{let t=(a=null)=>{let u=JSON.parse(localStorage.getItem(n));return a?u[String(a)]:u},e=(a,u)=>{let h=t();h[String(a)]=u,localStorage.setItem(n,JSON.stringify(h))},r=a=>Object.keys(t()).includes(String(a)),s=a=>{if(!r(a))return;let u=t();delete u[String(a)],localStorage.setItem(n,JSON.stringify(u))},o=()=>localStorage.setItem(n,"{}");return localStorage.getItem(n)||o(),{set:e,get:t,has:r,clear:o,unset:s}};var xr=(()=>{let n={"#000000":"#ffffff","#ffffff":"#000000","#212529":"#f8f9fa","#f8f9fa":"#212529"},t=["#ffffff","#f8f9fa"],e=["#000000","#212529"],r=!1,s=null,o=null,a=()=>s.set("active","light"),u=()=>s.set("active","dark"),h=x=>{let P=o.getAttribute("content");o.setAttribute("content",x.some(R=>R===P)?n[P]:P)},d=()=>{a(),document.documentElement.setAttribute("data-bs-theme","light"),h(e)},m=()=>{u(),document.documentElement.setAttribute("data-bs-theme","dark"),h(t)},g=(x=null,P=null)=>{let R=s.get("active")==="dark";return x&&P?R?x:P:R};return{init:()=>{switch(s=bt("theme"),o=document.querySelector('meta[name="theme-color"]'),s.has("active")||(window.matchMedia("(prefers-color-scheme: dark)").matches?u():a()),document.documentElement.getAttribute("data-bs-theme")){case"dark":u();break;case"light":a();break;default:r=!0}g()?m():d()},spyTop:()=>{let x=R=>R.filter(M=>M.isIntersecting).forEach(M=>{let V=M.target.classList.contains("bg-white-black")?g(e[0],t[0]):g(e[1],t[1]);o.setAttribute("content",V)}),P=new IntersectionObserver(x,{rootMargin:"0% 0% -95% 0%"});document.querySelectorAll("section").forEach(R=>P.observe(R))},change:()=>g()?d():m(),isDarkMode:g,isAutoMode:()=>r}})();var Xc=(()=>{let n={id:"ID",en:"US",fr:"FR",de:"DE",es:"ES",zh:"CN",ja:"JP",ko:"KR",ar:"SA",ru:"RU",it:"IT",nl:"NL",pt:"PT",tr:"TR",th:"TH",vi:"VN",ms:"MY",hi:"IN"},t=null,e=null,r=null,s=null;return{on(o,a){return s.set(o,a),this},get(){let o=s.get(r);return s.clear(),o},getCountry(){return t},getLocale(){return e},getLanguage(){return r},setDefault(o){let a=!0;n[o]||(a=!1,console.warn("Language not found, please add manually in countryMapping")),t=a?n[o]:"US",r=a?o:"en",e=`${r}_${t}`},init(){s=new Map,this.setDefault(navigator.language.split("-").shift())}}})();var Yc=(()=>{let n=({uuid:m,own:g,name:_,presence:I,comment:S,created_at:D,is_admin:x,is_parent:P,gif_url:R,ip:M,user_agent:V,comments:O,like_count:F})=>({uuid:m,own:g,name:_,presence:I,comment:S,created_at:D,is_admin:x??!1,is_parent:P,gif_url:R,ip:M,user_agent:V,comments:O?.map(n)??[],like_count:F??0}),t=m=>m.map(n);return{uuidResponse:({uuid:m})=>({uuid:m}),tokenResponse:({token:m})=>({token:m}),statusResponse:({status:m})=>({status:m}),getCommentResponse:n,getCommentsResponse:t,getCommentsResponseV2:m=>({count:m.count,lists:t(m.lists)}),commentShowMore:(m,g=!1)=>({uuid:m,show:g}),postCommentRequest:(m,g,_,I,S)=>({id:m,name:g,presence:_,comment:I,gif_id:S}),postSessionRequest:(m,g)=>({email:m,password:g}),updateCommentRequest:(m,g,_)=>({presence:m,comment:g,gif_id:_})}})();var Pr=(()=>{let n=null,t=()=>n.get("token"),e=d=>n.set("token",d),r=d=>jt(Gc,"/api/session").body(d).send(Yc.tokenResponse).then(m=>(m.code===200&&e(m.data.token),m.code===200)),s=()=>n.unset("token"),o=()=>String(t()??".").split(".").length===3;return{init:()=>{n=bt("session")},guest:d=>jt(Nt,"/api/v2/config").withCache(1e3*60*30).withForceCache().token(d).send().then(m=>{if(m.code!==200)throw new Error("failed to get config.");let g=bt("config");for(let[_,I]of Object.entries(m.data))g.set(_,I);return e(d),m}),login:r,logout:s,decode:()=>{if(!o())return null;try{return JSON.parse(X.base64Decode(t().split(".")[1]))}catch{return null}},isAdmin:o,setToken:e,getToken:t}})();var Zc=(()=>{let n=null,t=!0,e=["input[data-offline-disabled]","button[data-offline-disabled]","select[data-offline-disabled]","textarea[data-offline-disabled]"],r=()=>t,s=()=>{let g=n.firstElementChild.firstElementChild;g.classList.remove("bg-success"),g.classList.add("bg-danger"),g.firstElementChild.innerHTML='<i class="fa-solid fa-ban me-2"></i>Koneksi tidak tersedia'},o=()=>{let g=n.firstElementChild.firstElementChild;g.classList.remove("bg-danger"),g.classList.add("bg-success"),g.firstElementChild.innerHTML='<i class="fa-solid fa-cloud me-2"></i>Koneksi tersedia kembali'},a=async()=>{t&&(await X.changeOpacity(n,!1),s())},u=()=>{document.querySelectorAll(e.join(", ")).forEach(g=>{g.dispatchEvent(new Event(r()?"online":"offline")),g.setAttribute("data-offline-disabled",r()?"false":"true"),g.tagName==="BUTTON"?r()?g.classList.remove("disabled"):g.classList.add("disabled"):r()?g.removeAttribute("disabled"):g.setAttribute("disabled","true")})},h=()=>{t=!1,s(),X.changeOpacity(n,!0),u()},d=()=>{t=!0,o(),X.timeOut(a,3e3),u()};return{init:()=>{window.addEventListener("online",d),window.addEventListener("offline",h),n=document.createElement("div"),n.classList.add("fixed-top","pe-none"),n.style.cssText="opacity: 0; z-index: 1057;",n.innerHTML=`
        ...
        </div>`,document.body.insertBefore(n,document.body.lastChild)},isOnline:r}})();var tu=()=>{};var ru=function(n){let t=[],e=0;for(let r=0;r<n.length;r++){let s=n.charCodeAt(r);s<128?t[e++]=s:s<2048?(t[e++]=s>>6|192,t[e++]=s&63|128):(s&64512)===55296&&r+1<n.length&&(n.charCodeAt(r+1)&64512)===56320?(s=65536+((s&1023)<<10)+(n.charCodeAt(++r)&1023),t[e++]=s>>18|240,t[e++]=s>>12&63|128,t[e++]=s>>6&63|128,t[e++]=s&63|128):(t[e++]=s>>12|224,t[e++]=s>>6&63|128,t[e++]=s&63|128)}return t},Zd=function(n){let t=[],e=0,r=0;for(;e<n.length;){let s=n[e++];if(s<128)t[r++]=String.fromCharCode(s);else if(s>191&&s<224){let o=n[e++];t[r++]=String.fromCharCode((s&31)<<6|o&63)}else if(s>239&&s<365){let o=n[e++],a=n[e++],u=n[e++],h=((s&7)<<18|(o&63)<<12|(a&63)<<6|u&63)-65536;t[r++]=String.fromCharCode(55296+(h>>10)),t[r++]=String.fromCharCode(56320+(h&1023))}else{let o=n[e++],a=n[e++];t[r++]=String.fromCharCode((s&15)<<12|(o&63)<<6|a&63)}}return t.join("")},su={byteToCharMap_:null,charToByteMap_:null,byteToCharMapWebSafe_:null,charToByteMapWebSafe_:null,ENCODED_VALS_BASE:"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",get ENCODED_VALS(){return this.ENCODED_VALS_BASE+"+/="},get ENCODED_VALS_WEBSAFE(){return this.ENCODED_VALS_BASE+"-_."},HAS_NATIVE_SUPPORT:typeof atob=="function",encodeByteArray(n,t){if(!Array.isArray(n))throw Error("encodeByteArray takes an array as a parameter");this.init_();let e=t?this.byteToCharMapWebSafe_:this.byteToCharMap_,r=[];for(let s=0;s<n.length;s+=3){let o=n[s],a=s+1<n.length,u=a?n[s+1]:0,h=s+2<n.length,d=h?n[s+2]:0,m=o>>2,g=(o&3)<<4|u>>4,_=(u&15)<<2|d>>6,I=d&63;h||(I=64,a||(_=64)),r.push(e[m],e[g],e[_],e[I])}return r.join("")},encodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?btoa(n):this.encodeByteArray(ru(n),t)},decodeString(n,t){return this.HAS_NATIVE_SUPPORT&&!t?atob(n):Zd(this.decodeStringToByteArray(n,t))},decodeStringToByteArray(n,t){this.init_();let e=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let s=0;s<n.length;){let o=e[n.charAt(s++)],u=s<n.length?e[n.charAt(s)]:0;++s;let d=s<n.length?e[n.charAt(s)]:64;++s;let g=s<n.length?e[n.charAt(s)]:64;if(++s,o==null||u==null||d==null||g==null)throw new ei;let _=o<<2|u>>4;if(r.push(_),d!==64){let I=u<<4&240|d>>2;if(r.push(I),g!==64){let S=d<<6&192|g;r.push(S)}}}return r},init_(){if(!this.byteToCharMap_){this.byteToCharMap_={},this.charToByteMap_={},this.byteToCharMapWebSafe_={},this.charToByteMapWebSafe_={};for(let n=0;n<this.ENCODED_VALS.length;n++)this.byteToCharMap_[n]=this.ENCODED_VALS.charAt(n),this.charToByteMap_[this.byteToCharMap_[n]]=n,this.byteToCharMapWebSafe_[n]=this.ENCODED_VALS_WEBSAFE.charAt(n),this.charToByteMapWebSafe_[this.byteToCharMapWebSafe_[n]]=n,n>=this.ENCODED_VALS_BASE.length&&(this.charToByteMap_[this.ENCODED_VALS_WEBSAFE.charAt(n)]=n,this.charToByteMapWebSafe_[this.ENCODED_VALS.charAt(n)]=n)}}},ei=class extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}},tf=function(n){let t=ru(n);return su.encodeByteArray(t,!0)},Fn=function(n){return tf(n).replace(/\./g,"")},iu=function(n){try{return su.decodeString(n,!0)}catch(t){console.error("base64Decode failed: ",t)}return null};function ou(){if(typeof self<"u")return self;if(typeof window<"u")return window;if(typeof global<"u")return global;throw new Error("Unable to locate global object.")}var ef=()=>ou().__FIREBASE_DEFAULTS__,nf=()=>{if(typeof process>"u"||typeof process.env>"u")return;let n=process.env.__FIREBASE_DEFAULTS__;if(n)return JSON.parse(n)},rf=()=>{if(typeof document>"u")return;let n;try{n=document.cookie.match(/__FIREBASE_DEFAULTS__=([^;]+)/)}catch{return}let t=n&&iu(n[1]);return t&&JSON.parse(t)},ni=()=>{try{return tu()||ef()||nf()||rf()}catch(n){console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${n}`);return}},sf=n=>{var t,e;return(e=(t=ni())===null||t===void 0?void 0:t.emulatorHosts)===null||e===void 0?void 0:e[n]},au=n=>{let t=sf(n);if(!t)return;let e=t.lastIndexOf(":");if(e<=0||e+1===t.length)throw new Error(`Invalid host ${t} with no separate hostname and port!`);let r=parseInt(t.substring(e+1),10);return t[0]==="["?[t.substring(1,e-1),r]:[t.substring(0,e),r]},ri=()=>{var n;return(n=ni())===null||n===void 0?void 0:n.config};var Dr=class{constructor(){this.reject=()=>{},this.resolve=()=>{},this.promise=new Promise((t,e)=>{this.resolve=t,this.reject=e})}wrapCallback(t){return(e,r)=>{e?this.reject(e):this.resolve(r),typeof t=="function"&&(this.promise.catch(()=>{}),t.length===1?t(e):t(e,r))}}};function Vr(n){try{return(n.startsWith("http://")||n.startsWith("https://")?new URL(n).hostname:n).endsWith(".cloudworkstations.dev")}catch{return!1}}async function cu(n){return(await fetch(n,{credentials:"include"})).ok}function uu(n,t){if(n.uid)throw new Error('The "uid" field is no longer supported by mockUserToken. Please use "sub" instead for Firebase Auth User ID.');let e={alg:"none",type:"JWT"},r=t||"demo-project",s=n.iat||0,o=n.sub||n.user_id;if(!o)throw new Error("mockUserToken must contain 'sub' or 'user_id' field!");let a=Object.assign({iss:`https://securetoken.google.com/${r}`,aud:r,iat:s,exp:s+3600,auth_time:s,sub:o,user_id:o,firebase:{sign_in_provider:"custom",identities:{}}},n);return[Fn(JSON.stringify(e)),Fn(JSON.stringify(a)),""].join(".")}var Mn={};function of(){let n={prod:[],emulator:[]};for(let t of Object.keys(Mn))Mn[t]?n.emulator.push(t):n.prod.push(t);return n}function af(n){let t=document.getElementById(n),e=!1;return t||(t=document.createElement("div"),t.setAttribute("id",n),e=!0),{created:e,element:t}}var eu=!1;function lu(n,t){if(typeof window>"u"||typeof document>"u"||!Vr(window.location.host)||Mn[n]===t||Mn[n]||eu)return;Mn[n]=t;function e(_){return`__firebase__banner__${_}`}let r="__firebase__banner",o=of().prod.length>0;function a(){let _=document.getElementById(r);_&&_.remove()}function u(_){_.style.display="flex",_.style.background="#7faaf0",_.style.position="fixed",_.style.bottom="5px",_.style.left="5px",_.style.padding=".5em",_.style.borderRadius="5px",_.style.alignItems="center"}function h(_,I){_.setAttribute("width","24"),_.setAttribute("id",I),_.setAttribute("height","24"),_.setAttribute("viewBox","0 0 24 24"),_.setAttribute("fill","none"),_.style.marginLeft="-6px"}function d(){let _=document.createElement("span");return _.style.cursor="pointer",_.style.marginLeft="16px",_.style.fontSize="24px",_.innerHTML=" &times;",_.onclick=()=>{eu=!0,a()},_}function m(_,I){_.setAttribute("id",I),_.innerText="Learn more",_.href="https://firebase.google.com/docs/studio/preview-apps#preview-backend",_.setAttribute("target","__blank"),_.style.paddingLeft="5px",_.style.textDecoration="underline"}function g(){let _=af(r),I=e("text"),S=document.getElementById(I)||document.createElement("span"),D=e("learnmore"),x=document.getElementById(D)||document.createElement("a"),P=e("preprendIcon"),R=document.getElementById(P)||document.createElementNS("http://www.w3.org/2000/svg","svg");if(_.created){let M=_.element;u(M),m(x,D);let V=d();h(R,P),M.append(R,S,x,V),document.body.appendChild(M)}o?(S.innerText="Preview backend disconnected.",R.innerHTML=`<g clip-path="url(#clip0_6013_33858)">
...
</defs>`,S.innerText="Preview backend running in this workspace."),S.setAttribute("id",I)}document.readyState==="loading"?window.addEventListener("DOMContentLoaded",g):g()}function hu(){return typeof navigator<"u"&&typeof navigator.userAgent=="string"?navigator.userAgent:""}function cf(){var n;let t=(n=ni())===null||n===void 0?void 0:n.forceEnvironment;if(t==="node")return!0;if(t==="browser")return!1;try{return Object.prototype.toString.call(global.process)==="[object process]"}catch{return!1}}function du(){return!cf()&&!!navigator.userAgent&&navigator.userAgent.includes("Safari")&&!navigator.userAgent.includes("Chrome")}function si(){try{return typeof indexedDB=="object"}catch{return!1}}function fu(){return new Promise((n,t)=>{try{let e=!0,r="validate-browser-context-for-indexeddb-analytics-module",s=self.indexedDB.open(r);s.onsuccess=()=>{s.result.close(),e||self.indexedDB.deleteDatabase(r),n(!0)},s.onupgradeneeded=()=>{e=!1},s.onerror=()=>{var o;t(((o=s.error)===null||o===void 0?void 0:o.message)||"")}}catch(e){t(e)}})}var uf="FirebaseError",zt=class n extends Error{constructor(t,e,r){super(e),this.code=t,this.customData=r,this.name=uf,Object.setPrototypeOf(this,n.prototype),Error.captureStackTrace&&Error.captureStackTrace(this,Bn.prototype.create)}},Bn=class{constructor(t,e,r){this.service=t,this.serviceName=e,this.errors=r}create(t,...e){let r=e[0]||{},s=`${this.service}/${t}`,o=this.errors[t],a=o?lf(o,r):"Error",u=`${this.serviceName}: ${a} (${s}).`;return new zt(s,u,r)}};function lf(n,t){return n.replace(hf,(e,r)=>{let s=t[r];return s!=null?String(s):`<${r}?>`})}var hf=/\{\$([^}]+)}/g;function $e(n,t){if(n===t)return!0;let e=Object.keys(n),r=Object.keys(t);for(let s of e){if(!r.includes(s))return!1;let o=n[s],a=t[s];if(nu(o)&&nu(a)){if(!$e(o,a))return!1}else if(o!==a)return!1}for(let s of r)if(!e.includes(s))return!1;return!0}function nu(n){return n!==null&&typeof n=="object"}var oy=4*60*60*1e3;function oe(n){return n&&n._delegate?n._delegate:n}var $t=class{constructor(t,e,r){this.name=t,this.instanceFactory=e,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}};var Ie="[DEFAULT]";var ii=class{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){let e=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(e)){let r=new Dr;if(this.instancesDeferred.set(e,r),this.isInitialized(e)||this.shouldAutoInitialize())try{let s=this.getOrInitializeService({instanceIdentifier:e});s&&r.resolve(s)}catch{}}return this.instancesDeferred.get(e).promise}getImmediate(t){var e;let r=this.normalizeInstanceIdentifier(t?.identifier),s=(e=t?.optional)!==null&&e!==void 0?e:!1;if(this.isInitialized(r)||this.shouldAutoInitialize())try{return this.getOrInitializeService({instanceIdentifier:r})}catch(o){if(s)return null;throw o}else{if(s)return null;throw Error(`Service ${this.name} is not available`)}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,!!this.shouldAutoInitialize()){if(ff(t))try{this.getOrInitializeService({instanceIdentifier:Ie})}catch{}for(let[e,r]of this.instancesDeferred.entries()){let s=this.normalizeInstanceIdentifier(e);try{let o=this.getOrInitializeService({instanceIdentifier:s});r.resolve(o)}catch{}}}}clearInstance(t=Ie){this.instancesDeferred.delete(t),this.instancesOptions.delete(t),this.instances.delete(t)}async delete(){let t=Array.from(this.instances.values());await Promise.all([...t.filter(e=>"INTERNAL"in e).map(e=>e.INTERNAL.delete()),...t.filter(e=>"_delete"in e).map(e=>e._delete())])}isComponentSet(){return this.component!=null}isInitialized(t=Ie){return this.instances.has(t)}getOptions(t=Ie){return this.instancesOptions.get(t)||{}}initialize(t={}){let{options:e={}}=t,r=this.normalizeInstanceIdentifier(t.instanceIdentifier);if(this.isInitialized(r))throw Error(`${this.name}(${r}) has already been initialized`);if(!this.isComponentSet())throw Error(`Component ${this.name} has not been registered yet`);let s=this.getOrInitializeService({instanceIdentifier:r,options:e});for(let[o,a]of this.instancesDeferred.entries()){let u=this.normalizeInstanceIdentifier(o);r===u&&a.resolve(s)}return s}onInit(t,e){var r;let s=this.normalizeInstanceIdentifier(e),o=(r=this.onInitCallbacks.get(s))!==null&&r!==void 0?r:new Set;o.add(t),this.onInitCallbacks.set(s,o);let a=this.instances.get(s);return a&&t(a,s),()=>{o.delete(t)}}invokeOnInitCallbacks(t,e){let r=this.onInitCallbacks.get(e);if(r)for(let s of r)try{s(t,e)}catch{}}getOrInitializeService({instanceIdentifier:t,options:e={}}){let r=this.instances.get(t);if(!r&&this.component&&(r=this.component.instanceFactory(this.container,{instanceIdentifier:df(t),options:e}),this.instances.set(t,r),this.instancesOptions.set(t,e),this.invokeOnInitCallbacks(r,t),this.component.onInstanceCreated))try{this.component.onInstanceCreated(this.container,t,r)}catch{}return r||null}normalizeInstanceIdentifier(t=Ie){return this.component?this.component.multipleInstances?t:Ie:t}shouldAutoInitialize(){return!!this.component&&this.component.instantiationMode!=="EXPLICIT"}};function df(n){return n===Ie?void 0:n}function ff(n){return n.instantiationMode==="EAGER"}var Nr=class{constructor(t){this.name=t,this.providers=new Map}addComponent(t){let e=this.getProvider(t.name);if(e.isComponentSet())throw new Error(`Component ${t.name} has already been registered with ${this.name}`);e.setComponent(t)}addOrOverwriteComponent(t){this.getProvider(t.name).isComponentSet()&&this.providers.delete(t.name),this.addComponent(t)}getProvider(t){if(this.providers.has(t))return this.providers.get(t);let e=new ii(t,this);return this.providers.set(t,e),e}getProviders(){return Array.from(this.providers.values())}};var mf=[],W;(function(n){n[n.DEBUG=0]="DEBUG",n[n.VERBOSE=1]="VERBOSE",n[n.INFO=2]="INFO",n[n.WARN=3]="WARN",n[n.ERROR=4]="ERROR",n[n.SILENT=5]="SILENT"})(W||(W={}));var pf={debug:W.DEBUG,verbose:W.VERBOSE,info:W.INFO,warn:W.WARN,error:W.ERROR,silent:W.SILENT},gf=W.INFO,yf={[W.DEBUG]:"log",[W.VERBOSE]:"log",[W.INFO]:"info",[W.WARN]:"warn",[W.ERROR]:"error"},_f=(n,t,...e)=>{if(t<n.logLevel)return;let r=new Date().toISOString(),s=yf[t];if(s)console[s](`[${r}]  ${n.name}:`,...e);else throw new Error(`Attempted to log a message with an invalid logType (value: ${t})`)},Ge=class{constructor(t){this.name=t,this._logLevel=gf,this._logHandler=_f,this._userLogHandler=null,mf.push(this)}get logLevel(){return this._logLevel}set logLevel(t){if(!(t in W))throw new TypeError(`Invalid value "${t}" assigned to \`logLevel\``);this._logLevel=t}setLogLevel(t){this._logLevel=typeof t=="string"?pf[t]:t}get logHandler(){return this._logHandler}set logHandler(t){if(typeof t!="function")throw new TypeError("Value assigned to `logHandler` must be a function");this._logHandler=t}get userLogHandler(){return this._userLogHandler}set userLogHandler(t){this._userLogHandler=t}debug(...t){this._userLogHandler&&this._userLogHandler(this,W.DEBUG,...t),this._logHandler(this,W.DEBUG,...t)}log(...t){this._userLogHandler&&this._userLogHandler(this,W.VERBOSE,...t),this._logHandler(this,W.VERBOSE,...t)}info(...t){this._userLogHandler&&this._userLogHandler(this,W.INFO,...t),this._logHandler(this,W.INFO,...t)}warn(...t){this._userLogHandler&&this._userLogHandler(this,W.WARN,...t),this._logHandler(this,W.WARN,...t)}error(...t){this._userLogHandler&&this._userLogHandler(this,W.ERROR,...t),this._logHandler(this,W.ERROR,...t)}};var wf=(n,t)=>t.some(e=>n instanceof e),mu,pu;function vf(){return mu||(mu=[IDBDatabase,IDBObjectStore,IDBIndex,IDBCursor,IDBTransaction])}function Ef(){return pu||(pu=[IDBCursor.prototype.advance,IDBCursor.prototype.continue,IDBCursor.prototype.continuePrimaryKey])}var gu=new WeakMap,ai=new WeakMap,yu=new WeakMap,oi=new WeakMap,ui=new WeakMap;function Tf(n){let t=new Promise((e,r)=>{let s=()=>{n.removeEventListener("success",o),n.removeEventListener("error",a)},o=()=>{e(kt(n.result)),s()},a=()=>{r(n.error),s()};n.addEventListener("success",o),n.addEventListener("error",a)});return t.then(e=>{e instanceof IDBCursor&&gu.set(e,n)}).catch(()=>{}),ui.set(t,n),t}function If(n){if(ai.has(n))return;let t=new Promise((e,r)=>{let s=()=>{n.removeEventListener("complete",o),n.removeEventListener("error",a),n.removeEventListener("abort",a)},o=()=>{e(),s()},a=()=>{r(n.error||new DOMException("AbortError","AbortError")),s()};n.addEventListener("complete",o),n.addEventListener("error",a),n.addEventListener("abort",a)});ai.set(n,t)}var ci={get(n,t,e){if(n instanceof IDBTransaction){if(t==="done")return ai.get(n);if(t==="objectStoreNames")return n.objectStoreNames||yu.get(n);if(t==="store")return e.objectStoreNames[1]?void 0:e.objectStore(e.objectStoreNames[0])}return kt(n[t])},set(n,t,e){return n[t]=e,!0},has(n,t){return n instanceof IDBTransaction&&(t==="done"||t==="store")?!0:t in n}};function _u(n){ci=n(ci)}function bf(n){return n===IDBDatabase.prototype.transaction&&!("objectStoreNames"in IDBTransaction.prototype)?function(t,...e){let r=n.call(kr(this),t,...e);return yu.set(r,t.sort?t.sort():[t]),kt(r)}:Ef().includes(n)?function(...t){return n.apply(kr(this),t),kt(gu.get(this))}:function(...t){return kt(n.apply(kr(this),t))}}function Af(n){return typeof n=="function"?bf(n):(n instanceof IDBTransaction&&If(n),wf(n,vf())?new Proxy(n,ci):n)}function kt(n){if(n instanceof IDBRequest)return Tf(n);if(oi.has(n))return oi.get(n);let t=Af(n);return t!==n&&(oi.set(n,t),ui.set(t,n)),t}var kr=n=>ui.get(n);function vu(n,t,{blocked:e,upgrade:r,blocking:s,terminated:o}={}){let a=indexedDB.open(n,t),u=kt(a);return r&&a.addEventListener("upgradeneeded",h=>{r(kt(a.result),h.oldVersion,h.newVersion,kt(a.transaction),h)}),e&&a.addEventListener("blocked",h=>e(h.oldVersion,h.newVersion,h)),u.then(h=>{o&&h.addEventListener("close",()=>o()),s&&h.addEventListener("versionchange",d=>s(d.oldVersion,d.newVersion,d))}).catch(()=>{}),u}var Sf=["get","getKey","getAll","getAllKeys","count"],Cf=["put","add","delete","clear"],li=new Map;function wu(n,t){if(!(n instanceof IDBDatabase&&!(t in n)&&typeof t=="string"))return;if(li.get(t))return li.get(t);let e=t.replace(/FromIndex$/,""),r=t!==e,s=Cf.includes(e);if(!(e in(r?IDBIndex:IDBObjectStore).prototype)||!(s||Sf.includes(e)))return;let o=async function(a,...u){let h=this.transaction(a,s?"readwrite":"readonly"),d=h.store;return r&&(d=d.index(u.shift())),(await Promise.all([d[e](...u),s&&h.done]))[0]};return li.set(t,o),o}_u(n=>({...n,get:(t,e,r)=>wu(t,e)||n.get(t,e,r),has:(t,e)=>!!wu(t,e)||n.has(t,e)}));var di=class{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(e=>{if(Rf(e)){let r=e.getImmediate();return`${r.library}/${r.version}`}else return null}).filter(e=>e).join(" ")}};function Rf(n){let t=n.getComponent();return t?.type==="VERSION"}var fi="@firebase/app",Eu="0.13.2";var Gt=new Ge("@firebase/app"),xf="@firebase/app-compat",Pf="@firebase/analytics-compat",Df="@firebase/analytics",Vf="@firebase/app-check-compat",Nf="@firebase/app-check",kf="@firebase/auth",Of="@firebase/auth-compat",Lf="@firebase/database",Mf="@firebase/data-connect",Ff="@firebase/database-compat",Bf="@firebase/functions",Uf="@firebase/functions-compat",qf="@firebase/installations",jf="@firebase/installations-compat",zf="@firebase/messaging",$f="@firebase/messaging-compat",Gf="@firebase/performance",Kf="@firebase/performance-compat",Hf="@firebase/remote-config",Wf="@firebase/remote-config-compat",Qf="@firebase/storage",Jf="@firebase/storage-compat",Xf="@firebase/firestore",Yf="@firebase/ai",Zf="@firebase/firestore-compat",tm="firebase",em="11.10.0";var mi="[DEFAULT]",nm={[fi]:"fire-core",[xf]:"fire-core-compat",[Df]:"fire-analytics",[Pf]:"fire-analytics-compat",[Nf]:"fire-app-check",[Vf]:"fire-app-check-compat",[kf]:"fire-auth",[Of]:"fire-auth-compat",[Lf]:"fire-rtdb",[Mf]:"fire-data-connect",[Ff]:"fire-rtdb-compat",[Bf]:"fire-fn",[Uf]:"fire-fn-compat",[qf]:"fire-iid",[jf]:"fire-iid-compat",[zf]:"fire-fcm",[$f]:"fire-fcm-compat",[Gf]:"fire-perf",[Kf]:"fire-perf-compat",[Hf]:"fire-rc",[Wf]:"fire-rc-compat",[Qf]:"fire-gcs",[Jf]:"fire-gcs-compat",[Xf]:"fire-fst",[Zf]:"fire-fst-compat",[Yf]:"fire-vertex","fire-js":"fire-js",[tm]:"fire-js-all"};var Or=new Map,rm=new Map,pi=new Map;function Tu(n,t){try{n.container.addComponent(t)}catch(e){Gt.debug(`Component ${t.name} failed to register with FirebaseApp ${n.name}`,e)}}function Un(n){let t=n.name;if(pi.has(t))return Gt.debug(`There were multiple attempts to register component ${t}.`),!1;pi.set(t,n);for(let e of Or.values())Tu(e,n);for(let e of rm.values())Tu(e,n);return!0}function Su(n,t){let e=n.container.getProvider("heartbeat").getImmediate({optional:!0});return e&&e.triggerHeartbeat(),n.container.getProvider(t)}function Cu(n){return n==null?!1:n.settings!==void 0}var sm={"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}'","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","server-app-deleted":"Firebase Server App has been deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}.","finalization-registry-not-supported":"FirebaseServerApp deleteOnDeref field defined but the JS runtime does not support FinalizationRegistry.","invalid-server-app-environment":"FirebaseServerApp is not for use in browser environments."},ae=new Bn("app","Firebase",sm);var gi=class{constructor(t,e,r){this._isDeleted=!1,this._options=Object.assign({},t),this._config=Object.assign({},e),this._name=e.name,this._automaticDataCollectionEnabled=e.automaticDataCollectionEnabled,this._container=r,this.container.addComponent(new $t("app",()=>this,"PUBLIC"))}get automaticDataCollectionEnabled(){return this.checkDestroyed(),this._automaticDataCollectionEnabled}set automaticDataCollectionEnabled(t){this.checkDestroyed(),this._automaticDataCollectionEnabled=t}get name(){return this.checkDestroyed(),this._name}get options(){return this.checkDestroyed(),this._options}get config(){return this.checkDestroyed(),this._config}get container(){return this._container}get isDeleted(){return this._isDeleted}set isDeleted(t){this._isDeleted=t}checkDestroyed(){if(this.isDeleted)throw ae.create("app-deleted",{appName:this._name})}};var Ru=em;function wi(n,t={}){let e=n;typeof t!="object"&&(t={name:t});let r=Object.assign({name:mi,automaticDataCollectionEnabled:!0},t),s=r.name;if(typeof s!="string"||!s)throw ae.create("bad-app-name",{appName:String(s)});if(e||(e=ri()),!e)throw ae.create("no-options");let o=Or.get(s);if(o){if($e(e,o.options)&&$e(r,o.config))return o;throw ae.create("duplicate-app",{appName:s})}let a=new Nr(s);for(let h of pi.values())a.addComponent(h);let u=new gi(e,r,a);return Or.set(s,u),u}function xu(n=mi){let t=Or.get(n);if(!t&&n===mi&&ri())return wi();if(!t)throw ae.create("no-app",{appName:n});return t}function ce(n,t,e){var r;let s=(r=nm[n])!==null&&r!==void 0?r:n;e&&(s+=`-${e}`);let o=s.match(/\s|\//),a=t.match(/\s|\//);if(o||a){let u=[`Unable to register library "${s}" with version "${t}":`];o&&u.push(`library name "${s}" contains illegal characters (whitespace or "/")`),o&&a&&u.push("and"),a&&u.push(`version name "${t}" contains illegal characters (whitespace or "/")`),Gt.warn(u.join(" "));return}Un(new $t(`${s}-version`,()=>({library:s,version:t}),"VERSION"))}var im="firebase-heartbeat-database",om=1,qn="firebase-heartbeat-store",hi=null;function Pu(){return hi||(hi=vu(im,om,{upgrade:(n,t)=>{switch(t){case 0:try{n.createObjectStore(qn)}catch(e){console.warn(e)}}}}).catch(n=>{throw ae.create("idb-open",{originalErrorMessage:n.message})})),hi}async function am(n){try{let e=(await Pu()).transaction(qn),r=await e.objectStore(qn).get(Du(n));return await e.done,r}catch(t){if(t instanceof zt)Gt.warn(t.message);else{let e=ae.create("idb-get",{originalErrorMessage:t?.message});Gt.warn(e.message)}}}async function Iu(n,t){try{let r=(await Pu()).transaction(qn,"readwrite");await r.objectStore(qn).put(t,Du(n)),await r.done}catch(e){if(e instanceof zt)Gt.warn(e.message);else{let r=ae.create("idb-set",{originalErrorMessage:e?.message});Gt.warn(r.message)}}}function Du(n){return`${n.name}!${n.options.appId}`}var cm=1024,um=30,yi=class{constructor(t){this.container=t,this._heartbeatsCache=null;let e=this.container.getProvider("app").getImmediate();this._storage=new _i(e),this._heartbeatsCachePromise=this._storage.read().then(r=>(this._heartbeatsCache=r,r))}async triggerHeartbeat(){var t,e;try{let s=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),o=bu();if(((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null&&(this._heartbeatsCache=await this._heartbeatsCachePromise,((e=this._heartbeatsCache)===null||e===void 0?void 0:e.heartbeats)==null)||this._heartbeatsCache.lastSentHeartbeatDate===o||this._heartbeatsCache.heartbeats.some(a=>a.date===o))return;if(this._heartbeatsCache.heartbeats.push({date:o,agent:s}),this._heartbeatsCache.heartbeats.length>um){let a=hm(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(a,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(r){Gt.warn(r)}}async getHeartbeatsHeader(){var t;try{if(this._heartbeatsCache===null&&await this._heartbeatsCachePromise,((t=this._heartbeatsCache)===null||t===void 0?void 0:t.heartbeats)==null||this._heartbeatsCache.heartbeats.length===0)return"";let e=bu(),{heartbeatsToSend:r,unsentEntries:s}=lm(this._heartbeatsCache.heartbeats),o=Fn(JSON.stringify({version:2,heartbeats:r}));return this._heartbeatsCache.lastSentHeartbeatDate=e,s.length>0?(this._heartbeatsCache.heartbeats=s,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),o}catch(e){return Gt.warn(e),""}}};function bu(){return new Date().toISOString().substring(0,10)}function lm(n,t=cm){let e=[],r=n.slice();for(let s of n){let o=e.find(a=>a.agent===s.agent);if(o){if(o.dates.push(s.date),Au(e)>t){o.dates.pop();break}}else if(e.push({agent:s.agent,dates:[s.date]}),Au(e)>t){e.pop();break}r=r.slice(1)}return{heartbeatsToSend:e,unsentEntries:r}}var _i=class{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return si()?fu().then(()=>!0).catch(()=>!1):!1}async read(){if(await this._canUseIndexedDBPromise){let e=await am(this.app);return e?.heartbeats?e:{heartbeats:[]}}else return{heartbeats:[]}}async overwrite(t){var e;if(await this._canUseIndexedDBPromise){let s=await this.read();return Iu(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:t.heartbeats})}else return}async add(t){var e;if(await this._canUseIndexedDBPromise){let s=await this.read();return Iu(this.app,{lastSentHeartbeatDate:(e=t.lastSentHeartbeatDate)!==null&&e!==void 0?e:s.lastSentHeartbeatDate,heartbeats:[...s.heartbeats,...t.heartbeats]})}else return}};function Au(n){return Fn(JSON.stringify({version:2,heartbeats:n})).length}function hm(n){if(n.length===0)return-1;let t=0,e=n[0].date;for(let r=1;r<n.length;r++)n[r].date<e&&(e=n[r].date,t=r);return t}function dm(n){Un(new $t("platform-logger",t=>new di(t),"PRIVATE")),Un(new $t("heartbeat",t=>new yi(t),"PRIVATE")),ce(fi,Eu,n),ce(fi,Eu,"esm2017"),ce("fire-js","")}dm("");var fm="firebase",mm="11.10.0";ce(fm,mm,"app");var Vu=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},Nu={};var Kt,vi;(function(){var n;function t(v,p){function y(){}y.prototype=p.prototype,v.D=p.prototype,v.prototype=new y,v.prototype.constructor=v,v.C=function(E,T,A){for(var w=Array(arguments.length-2),Vt=2;Vt<arguments.length;Vt++)w[Vt-2]=arguments[Vt];return p.prototype[T].apply(E,w)}}function e(){this.blockSize=-1}function r(){this.blockSize=-1,this.blockSize=64,this.g=Array(4),this.B=Array(this.blockSize),this.o=this.h=0,this.s()}t(r,e),r.prototype.s=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.o=this.h=0};function s(v,p,y){y||(y=0);var E=Array(16);if(typeof p=="string")for(var T=0;16>T;++T)E[T]=p.charCodeAt(y++)|p.charCodeAt(y++)<<8|p.charCodeAt(y++)<<16|p.charCodeAt(y++)<<24;else for(T=0;16>T;++T)E[T]=p[y++]|p[y++]<<8|p[y++]<<16|p[y++]<<24;p=v.g[0],y=v.g[1],T=v.g[2];var A=v.g[3],w=p+(A^y&(T^A))+E[0]+3614090360&4294967295;p=y+(w<<7&4294967295|w>>>25),w=A+(T^p&(y^T))+E[1]+3905402710&4294967295,A=p+(w<<12&4294967295|w>>>20),w=T+(y^A&(p^y))+E[2]+606105819&4294967295,T=A+(w<<17&4294967295|w>>>15),w=y+(p^T&(A^p))+E[3]+3250441966&4294967295,y=T+(w<<22&4294967295|w>>>10),w=p+(A^y&(T^A))+E[4]+4118548399&4294967295,p=y+(w<<7&4294967295|w>>>25),w=A+(T^p&(y^T))+E[5]+1200080426&4294967295,A=p+(w<<12&4294967295|w>>>20),w=T+(y^A&(p^y))+E[6]+2821735955&4294967295,T=A+(w<<17&4294967295|w>>>15),w=y+(p^T&(A^p))+E[7]+4249261313&4294967295,y=T+(w<<22&4294967295|w>>>10),w=p+(A^y&(T^A))+E[8]+1770035416&4294967295,p=y+(w<<7&4294967295|w>>>25),w=A+(T^p&(y^T))+E[9]+2336552879&4294967295,A=p+(w<<12&4294967295|w>>>20),w=T+(y^A&(p^y))+E[10]+4294925233&4294967295,T=A+(w<<17&4294967295|w>>>15),w=y+(p^T&(A^p))+E[11]+2304563134&4294967295,y=T+(w<<22&4294967295|w>>>10),w=p+(A^y&(T^A))+E[12]+1804603682&4294967295,p=y+(w<<7&4294967295|w>>>25),w=A+(T^p&(y^T))+E[13]+4254626195&4294967295,A=p+(w<<12&4294967295|w>>>20),w=T+(y^A&(p^y))+E[14]+2792965006&4294967295,T=A+(w<<17&4294967295|w>>>15),w=y+(p^T&(A^p))+E[15]+1236535329&4294967295,y=T+(w<<22&4294967295|w>>>10),w=p+(T^A&(y^T))+E[1]+4129170786&4294967295,p=y+(w<<5&4294967295|w>>>27),w=A+(y^T&(p^y))+E[6]+3225465664&4294967295,A=p+(w<<9&4294967295|w>>>23),w=T+(p^y&(A^p))+E[11]+643717713&4294967295,T=A+(w<<14&4294967295|w>>>18),w=y+(A^p&(T^A))+E[0]+3921069994&4294967295,y=T+(w<<20&4294967295|w>>>12),w=p+(T^A&(y^T))+E[5]+3593408605&4294967295,p=y+(w<<5&4294967295|w>>>27),w=A+(y^T&(p^y))+E[10]+38016083&4294967295,A=p+(w<<9&4294967295|w>>>23),w=T+(p^y&(A^p))+E[15]+3634488961&4294967295,T=A+(w<<14&4294967295|w>>>18),w=y+(A^p&(T^A))+E[4]+3889429448&4294967295,y=T+(w<<20&4294967295|w>>>12),w=p+(T^A&(y^T))+E[9]+568446438&4294967295,p=y+(w<<5&4294967295|w>>>27),w=A+(y^T&(p^y))+E[14]+3275163606&4294967295,A=p+(w<<9&4294967295|w>>>23),w=T+(p^y&(A^p))+E[3]+4107603335&4294967295,T=A+(w<<14&4294967295|w>>>18),w=y+(A^p&(T^A))+E[8]+1163531501&4294967295,y=T+(w<<20&4294967295|w>>>12),w=p+(T^A&(y^T))+E[13]+2850285829&4294967295,p=y+(w<<5&4294967295|w>>>27),w=A+(y^T&(p^y))+E[2]+4243563512&4294967295,A=p+(w<<9&4294967295|w>>>23),w=T+(p^y&(A^p))+E[7]+1735328473&4294967295,T=A+(w<<14&4294967295|w>>>18),w=y+(A^p&(T^A))+E[12]+2368359562&4294967295,y=T+(w<<20&4294967295|w>>>12),w=p+(y^T^A)+E[5]+4294588738&4294967295,p=y+(w<<4&4294967295|w>>>28),w=A+(p^y^T)+E[8]+2272392833&4294967295,A=p+(w<<11&4294967295|w>>>21),w=T+(A^p^y)+E[11]+1839030562&4294967295,T=A+(w<<16&4294967295|w>>>16),w=y+(T^A^p)+E[14]+4259657740&4294967295,y=T+(w<<23&4294967295|w>>>9),w=p+(y^T^A)+E[1]+2763975236&4294967295,p=y+(w<<4&4294967295|w>>>28),w=A+(p^y^T)+E[4]+1272893353&4294967295,A=p+(w<<11&4294967295|w>>>21),w=T+(A^p^y)+E[7]+4139469664&4294967295,T=A+(w<<16&4294967295|w>>>16),w=y+(T^A^p)+E[10]+3200236656&4294967295,y=T+(w<<23&4294967295|w>>>9),w=p+(y^T^A)+E[13]+681279174&4294967295,p=y+(w<<4&4294967295|w>>>28),w=A+(p^y^T)+E[0]+3936430074&4294967295,A=p+(w<<11&4294967295|w>>>21),w=T+(A^p^y)+E[3]+3572445317&4294967295,T=A+(w<<16&4294967295|w>>>16),w=y+(T^A^p)+E[6]+76029189&4294967295,y=T+(w<<23&4294967295|w>>>9),w=p+(y^T^A)+E[9]+3654602809&4294967295,p=y+(w<<4&4294967295|w>>>28),w=A+(p^y^T)+E[12]+3873151461&4294967295,A=p+(w<<11&4294967295|w>>>21),w=T+(A^p^y)+E[15]+530742520&4294967295,T=A+(w<<16&4294967295|w>>>16),w=y+(T^A^p)+E[2]+3299628645&4294967295,y=T+(w<<23&4294967295|w>>>9),w=p+(T^(y|~A))+E[0]+4096336452&4294967295,p=y+(w<<6&4294967295|w>>>26),w=A+(y^(p|~T))+E[7]+1126891415&4294967295,A=p+(w<<10&4294967295|w>>>22),w=T+(p^(A|~y))+E[14]+2878612391&4294967295,T=A+(w<<15&4294967295|w>>>17),w=y+(A^(T|~p))+E[5]+4237533241&4294967295,y=T+(w<<21&4294967295|w>>>11),w=p+(T^(y|~A))+E[12]+1700485571&4294967295,p=y+(w<<6&4294967295|w>>>26),w=A+(y^(p|~T))+E[3]+2399980690&4294967295,A=p+(w<<10&4294967295|w>>>22),w=T+(p^(A|~y))+E[10]+4293915773&4294967295,T=A+(w<<15&4294967295|w>>>17),w=y+(A^(T|~p))+E[1]+2240044497&4294967295,y=T+(w<<21&4294967295|w>>>11),w=p+(T^(y|~A))+E[8]+1873313359&4294967295,p=y+(w<<6&4294967295|w>>>26),w=A+(y^(p|~T))+E[15]+4264355552&4294967295,A=p+(w<<10&4294967295|w>>>22),w=T+(p^(A|~y))+E[6]+2734768916&4294967295,T=A+(w<<15&4294967295|w>>>17),w=y+(A^(T|~p))+E[13]+1309151649&4294967295,y=T+(w<<21&4294967295|w>>>11),w=p+(T^(y|~A))+E[4]+4149444226&4294967295,p=y+(w<<6&4294967295|w>>>26),w=A+(y^(p|~T))+E[11]+3174756917&4294967295,A=p+(w<<10&4294967295|w>>>22),w=T+(p^(A|~y))+E[2]+718787259&4294967295,T=A+(w<<15&4294967295|w>>>17),w=y+(A^(T|~p))+E[9]+3951481745&4294967295,v.g[0]=v.g[0]+p&4294967295,v.g[1]=v.g[1]+(T+(w<<21&4294967295|w>>>11))&4294967295,v.g[2]=v.g[2]+T&4294967295,v.g[3]=v.g[3]+A&4294967295}r.prototype.u=function(v,p){p===void 0&&(p=v.length);for(var y=p-this.blockSize,E=this.B,T=this.h,A=0;A<p;){if(T==0)for(;A<=y;)s(this,v,A),A+=this.blockSize;if(typeof v=="string"){for(;A<p;)if(E[T++]=v.charCodeAt(A++),T==this.blockSize){s(this,E),T=0;break}}else for(;A<p;)if(E[T++]=v[A++],T==this.blockSize){s(this,E),T=0;break}}this.h=T,this.o+=p},r.prototype.v=function(){var v=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);v[0]=128;for(var p=1;p<v.length-8;++p)v[p]=0;var y=8*this.o;for(p=v.length-8;p<v.length;++p)v[p]=y&255,y/=256;for(this.u(v),v=Array(16),p=y=0;4>p;++p)for(var E=0;32>E;E+=8)v[y++]=this.g[p]>>>E&255;return v};function o(v,p){var y=u;return Object.prototype.hasOwnProperty.call(y,v)?y[v]:y[v]=p(v)}function a(v,p){this.h=p;for(var y=[],E=!0,T=v.length-1;0<=T;T--){var A=v[T]|0;E&&A==p||(y[T]=A,E=!1)}this.g=y}var u={};function h(v){return-128<=v&&128>v?o(v,function(p){return new a([p|0],0>p?-1:0)}):new a([v|0],0>v?-1:0)}function d(v){if(isNaN(v)||!isFinite(v))return g;if(0>v)return x(d(-v));for(var p=[],y=1,E=0;v>=y;E++)p[E]=v/y|0,y*=4294967296;return new a(p,0)}function m(v,p){if(v.length==0)throw Error("number format error: empty string");if(p=p||10,2>p||36<p)throw Error("radix out of range: "+p);if(v.charAt(0)=="-")return x(m(v.substring(1),p));if(0<=v.indexOf("-"))throw Error('number format error: interior "-" character');for(var y=d(Math.pow(p,8)),E=g,T=0;T<v.length;T+=8){var A=Math.min(8,v.length-T),w=parseInt(v.substring(T,T+A),p);8>A?(A=d(Math.pow(p,A)),E=E.j(A).add(d(w))):(E=E.j(y),E=E.add(d(w)))}return E}var g=h(0),_=h(1),I=h(16777216);n=a.prototype,n.m=function(){if(D(this))return-x(this).m();for(var v=0,p=1,y=0;y<this.g.length;y++){var E=this.i(y);v+=(0<=E?E:4294967296+E)*p,p*=4294967296}return v},n.toString=function(v){if(v=v||10,2>v||36<v)throw Error("radix out of range: "+v);if(S(this))return"0";if(D(this))return"-"+x(this).toString(v);for(var p=d(Math.pow(v,6)),y=this,E="";;){var T=V(y,p).g;y=P(y,T.j(p));var A=((0<y.g.length?y.g[0]:y.h)>>>0).toString(v);if(y=T,S(y))return A+E;for(;6>A.length;)A="0"+A;E=A+E}},n.i=function(v){return 0>v?0:v<this.g.length?this.g[v]:this.h};function S(v){if(v.h!=0)return!1;for(var p=0;p<v.g.length;p++)if(v.g[p]!=0)return!1;return!0}function D(v){return v.h==-1}n.l=function(v){return v=P(this,v),D(v)?-1:S(v)?0:1};function x(v){for(var p=v.g.length,y=[],E=0;E<p;E++)y[E]=~v.g[E];return new a(y,~v.h).add(_)}n.abs=function(){return D(this)?x(this):this},n.add=function(v){for(var p=Math.max(this.g.length,v.g.length),y=[],E=0,T=0;T<=p;T++){var A=E+(this.i(T)&65535)+(v.i(T)&65535),w=(A>>>16)+(this.i(T)>>>16)+(v.i(T)>>>16);E=w>>>16,A&=65535,w&=65535,y[T]=w<<16|A}return new a(y,y[y.length-1]&-2147483648?-1:0)};function P(v,p){return v.add(x(p))}n.j=function(v){if(S(this)||S(v))return g;if(D(this))return D(v)?x(this).j(x(v)):x(x(this).j(v));if(D(v))return x(this.j(x(v)));if(0>this.l(I)&&0>v.l(I))return d(this.m()*v.m());for(var p=this.g.length+v.g.length,y=[],E=0;E<2*p;E++)y[E]=0;for(E=0;E<this.g.length;E++)for(var T=0;T<v.g.length;T++){var A=this.i(E)>>>16,w=this.i(E)&65535,Vt=v.i(T)>>>16,Ct=v.i(T)&65535;y[2*E+2*T]+=w*Ct,R(y,2*E+2*T),y[2*E+2*T+1]+=A*Ct,R(y,2*E+2*T+1),y[2*E+2*T+1]+=w*Vt,R(y,2*E+2*T+1),y[2*E+2*T+2]+=A*Vt,R(y,2*E+2*T+2)}for(E=0;E<p;E++)y[E]=y[2*E+1]<<16|y[2*E];for(E=p;E<2*p;E++)y[E]=0;return new a(y,0)};function R(v,p){for(;(v[p]&65535)!=v[p];)v[p+1]+=v[p]>>>16,v[p]&=65535,p++}function M(v,p){this.g=v,this.h=p}function V(v,p){if(S(p))throw Error("division by zero");if(S(v))return new M(g,g);if(D(v))return p=V(x(v),p),new M(x(p.g),x(p.h));if(D(p))return p=V(v,x(p)),new M(x(p.g),p.h);if(30<v.g.length){if(D(v)||D(p))throw Error("slowDivide_ only works with positive integers.");for(var y=_,E=p;0>=E.l(v);)y=O(y),E=O(E);var T=F(y,1),A=F(E,1);for(E=F(E,2),y=F(y,2);!S(E);){var w=A.add(E);0>=w.l(v)&&(T=T.add(y),A=w),E=F(E,1),y=F(y,1)}return p=P(v,T.j(p)),new M(T,p)}for(T=g;0<=v.l(p);){for(y=Math.max(1,Math.floor(v.m()/p.m())),E=Math.ceil(Math.log(y)/Math.LN2),E=48>=E?1:Math.pow(2,E-48),A=d(y),w=A.j(p);D(w)||0<w.l(v);)y-=E,A=d(y),w=A.j(p);S(A)&&(A=_),T=T.add(A),v=P(v,w)}return new M(T,v)}n.A=function(v){return V(this,v).h},n.and=function(v){for(var p=Math.max(this.g.length,v.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)&v.i(E);return new a(y,this.h&v.h)},n.or=function(v){for(var p=Math.max(this.g.length,v.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)|v.i(E);return new a(y,this.h|v.h)},n.xor=function(v){for(var p=Math.max(this.g.length,v.g.length),y=[],E=0;E<p;E++)y[E]=this.i(E)^v.i(E);return new a(y,this.h^v.h)};function O(v){for(var p=v.g.length+1,y=[],E=0;E<p;E++)y[E]=v.i(E)<<1|v.i(E-1)>>>31;return new a(y,v.h)}function F(v,p){var y=p>>5;p%=32;for(var E=v.g.length-y,T=[],A=0;A<E;A++)T[A]=0<p?v.i(A+y)>>>p|v.i(A+y+1)<<32-p:v.i(A+y);return new a(T,v.h)}r.prototype.digest=r.prototype.v,r.prototype.reset=r.prototype.s,r.prototype.update=r.prototype.u,vi=Nu.Md5=r,a.prototype.add=a.prototype.add,a.prototype.multiply=a.prototype.j,a.prototype.modulo=a.prototype.A,a.prototype.compare=a.prototype.l,a.prototype.toNumber=a.prototype.m,a.prototype.toString=a.prototype.toString,a.prototype.getBits=a.prototype.i,a.fromNumber=d,a.fromString=m,Kt=Nu.Integer=a}).apply(typeof Vu<"u"?Vu:typeof self<"u"?self:typeof window<"u"?window:{});var Lr=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{},Ht={};var Ei,pm,Ke,Ti,jn,Mr,Ii,bi,Ai;(function(){var n,t=typeof Object.defineProperties=="function"?Object.defineProperty:function(i,c,l){return i==Array.prototype||i==Object.prototype||(i[c]=l.value),i};function e(i){i=[typeof globalThis=="object"&&globalThis,i,typeof window=="object"&&window,typeof self=="object"&&self,typeof Lr=="object"&&Lr];for(var c=0;c<i.length;++c){var l=i[c];if(l&&l.Math==Math)return l}throw Error("Cannot find global object")}var r=e(this);function s(i,c){if(c)t:{var l=r;i=i.split(".");for(var f=0;f<i.length-1;f++){var b=i[f];if(!(b in l))break t;l=l[b]}i=i[i.length-1],f=l[i],c=c(f),c!=f&&c!=null&&t(l,i,{configurable:!0,writable:!0,value:c})}}function o(i,c){i instanceof String&&(i+="");var l=0,f=!1,b={next:function(){if(!f&&l<i.length){var C=l++;return{value:c(C,i[C]),done:!1}}return f=!0,{done:!0,value:void 0}}};return b[Symbol.iterator]=function(){return b},b}s("Array.prototype.values",function(i){return i||function(){return o(this,function(c,l){return l})}});var a=a||{},u=this||self;function h(i){var c=typeof i;return c=c!="object"?c:i?Array.isArray(i)?"array":c:"null",c=="array"||c=="object"&&typeof i.length=="number"}function d(i){var c=typeof i;return c=="object"&&i!=null||c=="function"}function m(i,c,l){return i.call.apply(i.bind,arguments)}function g(i,c,l){if(!i)throw Error();if(2<arguments.length){var f=Array.prototype.slice.call(arguments,2);return function(){var b=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(b,f),i.apply(c,b)}}return function(){return i.apply(c,arguments)}}function _(i,c,l){return _=Function.prototype.bind&&Function.prototype.bind.toString().indexOf("native code")!=-1?m:g,_.apply(null,arguments)}function I(i,c){var l=Array.prototype.slice.call(arguments,1);return function(){var f=l.slice();return f.push.apply(f,arguments),i.apply(this,f)}}function S(i,c){function l(){}l.prototype=c.prototype,i.aa=c.prototype,i.prototype=new l,i.prototype.constructor=i,i.Qb=function(f,b,C){for(var L=Array(arguments.length-2),Z=2;Z<arguments.length;Z++)L[Z-2]=arguments[Z];return c.prototype[b].apply(f,L)}}function D(i){let c=i.length;if(0<c){let l=Array(c);for(let f=0;f<c;f++)l[f]=i[f];return l}return[]}function x(i,c){for(let l=1;l<arguments.length;l++){let f=arguments[l];if(h(f)){let b=i.length||0,C=f.length||0;i.length=b+C;for(let L=0;L<C;L++)i[b+L]=f[L]}else i.push(f)}}class P{constructor(c,l){this.i=c,this.j=l,this.h=0,this.g=null}get(){let c;return 0<this.h?(this.h--,c=this.g,this.g=c.next,c.next=null):c=this.i(),c}}function R(i){return/^[\s\xa0]*$/.test(i)}function M(){var i=u.navigator;return i&&(i=i.userAgent)?i:""}function V(i){return V[" "](i),i}V[" "]=function(){};var O=M().indexOf("Gecko")!=-1&&!(M().toLowerCase().indexOf("webkit")!=-1&&M().indexOf("Edge")==-1)&&!(M().indexOf("Trident")!=-1||M().indexOf("MSIE")!=-1)&&M().indexOf("Edge")==-1;function F(i,c,l){for(let f in i)c.call(l,i[f],f,i)}function v(i,c){for(let l in i)c.call(void 0,i[l],l,i)}function p(i){let c={};for(let l in i)c[l]=i[l];return c}let y="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function E(i,c){let l,f;for(let b=1;b<arguments.length;b++){f=arguments[b];for(l in f)i[l]=f[l];for(let C=0;C<y.length;C++)l=y[C],Object.prototype.hasOwnProperty.call(f,l)&&(i[l]=f[l])}}function T(i){var c=1;i=i.split(":");let l=[];for(;0<c&&i.length;)l.push(i.shift()),c--;return i.length&&l.push(i.join(":")),l}function A(i){u.setTimeout(()=>{throw i},0)}function w(){var i=Ps;let c=null;return i.g&&(c=i.g,i.g=i.g.next,i.g||(i.h=null),c.next=null),c}class Vt{constructor(){this.h=this.g=null}add(c,l){let f=Ct.get();f.set(c,l),this.h?this.h.next=f:this.g=f,this.h=f}}var Ct=new P(()=>new hr,i=>i.reset());class hr{constructor(){this.next=this.g=this.h=null}set(c,l){this.h=c,this.g=l,this.next=null}reset(){this.next=this.g=this.h=null}}let _e,Tt=!1,Ps=new Vt,ja=()=>{let i=u.Promise.resolve(void 0);_e=()=>{i.then(ld)}};var ld=()=>{for(var i;i=w();){try{i.h.call(i.g)}catch(l){A(l)}var c=Ct;c.j(i),100>c.h&&(c.h++,i.next=c.g,c.g=i)}Tt=!1};function ee(){this.s=this.s,this.C=this.C}ee.prototype.s=!1,ee.prototype.ma=function(){this.s||(this.s=!0,this.N())},ee.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function ft(i,c){this.type=i,this.g=this.target=c,this.defaultPrevented=!1}ft.prototype.h=function(){this.defaultPrevented=!0};var hd=function(){if(!u.addEventListener||!Object.defineProperty)return!1;var i=!1,c=Object.defineProperty({},"passive",{get:function(){i=!0}});try{let l=()=>{};u.addEventListener("test",l,c),u.removeEventListener("test",l,c)}catch{}return i}();function wn(i,c){if(ft.call(this,i?i.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,i){var l=this.type=i.type,f=i.changedTouches&&i.changedTouches.length?i.changedTouches[0]:null;if(this.target=i.target||i.srcElement,this.g=c,c=i.relatedTarget){if(O){t:{try{V(c.nodeName);var b=!0;break t}catch{}b=!1}b||(c=null)}}else l=="mouseover"?c=i.fromElement:l=="mouseout"&&(c=i.toElement);this.relatedTarget=c,f?(this.clientX=f.clientX!==void 0?f.clientX:f.pageX,this.clientY=f.clientY!==void 0?f.clientY:f.pageY,this.screenX=f.screenX||0,this.screenY=f.screenY||0):(this.clientX=i.clientX!==void 0?i.clientX:i.pageX,this.clientY=i.clientY!==void 0?i.clientY:i.pageY,this.screenX=i.screenX||0,this.screenY=i.screenY||0),this.button=i.button,this.key=i.key||"",this.ctrlKey=i.ctrlKey,this.altKey=i.altKey,this.shiftKey=i.shiftKey,this.metaKey=i.metaKey,this.pointerId=i.pointerId||0,this.pointerType=typeof i.pointerType=="string"?i.pointerType:dd[i.pointerType]||"",this.state=i.state,this.i=i,i.defaultPrevented&&wn.aa.h.call(this)}}S(wn,ft);var dd={2:"touch",3:"pen",4:"mouse"};wn.prototype.h=function(){wn.aa.h.call(this);var i=this.i;i.preventDefault?i.preventDefault():i.returnValue=!1};var vn="closure_listenable_"+(1e6*Math.random()|0),fd=0;function md(i,c,l,f,b){this.listener=i,this.proxy=null,this.src=c,this.type=l,this.capture=!!f,this.ha=b,this.key=++fd,this.da=this.fa=!1}function dr(i){i.da=!0,i.listener=null,i.proxy=null,i.src=null,i.ha=null}function fr(i){this.src=i,this.g={},this.h=0}fr.prototype.add=function(i,c,l,f,b){var C=i.toString();i=this.g[C],i||(i=this.g[C]=[],this.h++);var L=Vs(i,c,f,b);return-1<L?(c=i[L],l||(c.fa=!1)):(c=new md(c,this.src,C,!!f,b),c.fa=l,i.push(c)),c};function Ds(i,c){var l=c.type;if(l in i.g){var f=i.g[l],b=Array.prototype.indexOf.call(f,c,void 0),C;(C=0<=b)&&Array.prototype.splice.call(f,b,1),C&&(dr(c),i.g[l].length==0&&(delete i.g[l],i.h--))}}function Vs(i,c,l,f){for(var b=0;b<i.length;++b){var C=i[b];if(!C.da&&C.listener==c&&C.capture==!!l&&C.ha==f)return b}return-1}var Ns="closure_lm_"+(1e6*Math.random()|0),ks={};function za(i,c,l,f,b){if(f&&f.once)return Ga(i,c,l,f,b);if(Array.isArray(c)){for(var C=0;C<c.length;C++)za(i,c[C],l,f,b);return null}return l=Fs(l),i&&i[vn]?i.K(c,l,d(f)?!!f.capture:!!f,b):$a(i,c,l,!1,f,b)}function $a(i,c,l,f,b,C){if(!c)throw Error("Invalid event type");var L=d(b)?!!b.capture:!!b,Z=Ls(i);if(Z||(i[Ns]=Z=new fr(i)),l=Z.add(c,l,f,L,C),l.proxy)return l;if(f=pd(),l.proxy=f,f.src=i,f.listener=l,i.addEventListener)hd||(b=L),b===void 0&&(b=!1),i.addEventListener(c.toString(),f,b);else if(i.attachEvent)i.attachEvent(Ha(c.toString()),f);else if(i.addListener&&i.removeListener)i.addListener(f);else throw Error("addEventListener and attachEvent are unavailable.");return l}function pd(){function i(l){return c.call(i.src,i.listener,l)}let c=gd;return i}function Ga(i,c,l,f,b){if(Array.isArray(c)){for(var C=0;C<c.length;C++)Ga(i,c[C],l,f,b);return null}return l=Fs(l),i&&i[vn]?i.L(c,l,d(f)?!!f.capture:!!f,b):$a(i,c,l,!0,f,b)}function Ka(i,c,l,f,b){if(Array.isArray(c))for(var C=0;C<c.length;C++)Ka(i,c[C],l,f,b);else f=d(f)?!!f.capture:!!f,l=Fs(l),i&&i[vn]?(i=i.i,c=String(c).toString(),c in i.g&&(C=i.g[c],l=Vs(C,l,f,b),-1<l&&(dr(C[l]),Array.prototype.splice.call(C,l,1),C.length==0&&(delete i.g[c],i.h--)))):i&&(i=Ls(i))&&(c=i.g[c.toString()],i=-1,c&&(i=Vs(c,l,f,b)),(l=-1<i?c[i]:null)&&Os(l))}function Os(i){if(typeof i!="number"&&i&&!i.da){var c=i.src;if(c&&c[vn])Ds(c.i,i);else{var l=i.type,f=i.proxy;c.removeEventListener?c.removeEventListener(l,f,i.capture):c.detachEvent?c.detachEvent(Ha(l),f):c.addListener&&c.removeListener&&c.removeListener(f),(l=Ls(c))?(Ds(l,i),l.h==0&&(l.src=null,c[Ns]=null)):dr(i)}}}function Ha(i){return i in ks?ks[i]:ks[i]="on"+i}function gd(i,c){if(i.da)i=!0;else{c=new wn(c,this);var l=i.listener,f=i.ha||i.src;i.fa&&Os(i),i=l.call(f,c)}return i}function Ls(i){return i=i[Ns],i instanceof fr?i:null}var Ms="__closure_events_fn_"+(1e9*Math.random()>>>0);function Fs(i){return typeof i=="function"?i:(i[Ms]||(i[Ms]=function(c){return i.handleEvent(c)}),i[Ms])}function mt(){ee.call(this),this.i=new fr(this),this.M=this,this.F=null}S(mt,ee),mt.prototype[vn]=!0,mt.prototype.removeEventListener=function(i,c,l,f){Ka(this,i,c,l,f)};function vt(i,c){var l,f=i.F;if(f)for(l=[];f;f=f.F)l.push(f);if(i=i.M,f=c.type||c,typeof c=="string")c=new ft(c,i);else if(c instanceof ft)c.target=c.target||i;else{var b=c;c=new ft(f,i),E(c,b)}if(b=!0,l)for(var C=l.length-1;0<=C;C--){var L=c.g=l[C];b=mr(L,f,!0,c)&&b}if(L=c.g=i,b=mr(L,f,!0,c)&&b,b=mr(L,f,!1,c)&&b,l)for(C=0;C<l.length;C++)L=c.g=l[C],b=mr(L,f,!1,c)&&b}mt.prototype.N=function(){if(mt.aa.N.call(this),this.i){var i=this.i,c;for(c in i.g){for(var l=i.g[c],f=0;f<l.length;f++)dr(l[f]);delete i.g[c],i.h--}}this.F=null},mt.prototype.K=function(i,c,l,f){return this.i.add(String(i),c,!1,l,f)},mt.prototype.L=function(i,c,l,f){return this.i.add(String(i),c,!0,l,f)};function mr(i,c,l,f){if(c=i.i.g[String(c)],!c)return!0;c=c.concat();for(var b=!0,C=0;C<c.length;++C){var L=c[C];if(L&&!L.da&&L.capture==l){var Z=L.listener,dt=L.ha||L.src;L.fa&&Ds(i.i,L),b=Z.call(dt,f)!==!1&&b}}return b&&!f.defaultPrevented}function Wa(i,c,l){if(typeof i=="function")l&&(i=_(i,l));else if(i&&typeof i.handleEvent=="function")i=_(i.handleEvent,i);else throw Error("Invalid listener argument");return 2147483647<Number(c)?-1:u.setTimeout(i,c||0)}function Qa(i){i.g=Wa(()=>{i.g=null,i.i&&(i.i=!1,Qa(i))},i.l);let c=i.h;i.h=null,i.m.apply(null,c)}class yd extends ee{constructor(c,l){super(),this.m=c,this.l=l,this.h=null,this.i=!1,this.g=null}j(c){this.h=arguments,this.g?this.i=!0:Qa(this)}N(){super.N(),this.g&&(u.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function En(i){ee.call(this),this.h=i,this.g={}}S(En,ee);var Ja=[];function Xa(i){F(i.g,function(c,l){this.g.hasOwnProperty(l)&&Os(c)},i),i.g={}}En.prototype.N=function(){En.aa.N.call(this),Xa(this)},En.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var Bs=u.JSON.stringify,_d=u.JSON.parse,wd=class{stringify(i){return u.JSON.stringify(i,void 0)}parse(i){return u.JSON.parse(i,void 0)}};function Us(){}Us.prototype.h=null;function Ya(i){return i.h||(i.h=i.i())}function Za(){}var Tn={OPEN:"a",kb:"b",Ja:"c",wb:"d"};function qs(){ft.call(this,"d")}S(qs,ft);function js(){ft.call(this,"c")}S(js,ft);var we={},tc=null;function pr(){return tc=tc||new mt}we.La="serverreachability";function ec(i){ft.call(this,we.La,i)}S(ec,ft);function In(i){let c=pr();vt(c,new ec(c))}we.STAT_EVENT="statevent";function nc(i,c){ft.call(this,we.STAT_EVENT,i),this.stat=c}S(nc,ft);function Et(i){let c=pr();vt(c,new nc(c,i))}we.Ma="timingevent";function rc(i,c){ft.call(this,we.Ma,i),this.size=c}S(rc,ft);function bn(i,c){if(typeof i!="function")throw Error("Fn must not be null and must be a function");return u.setTimeout(function(){i()},c)}function An(){this.g=!0}An.prototype.xa=function(){this.g=!1};function vd(i,c,l,f,b,C){i.info(function(){if(i.g)if(C)for(var L="",Z=C.split("&"),dt=0;dt<Z.length;dt++){var J=Z[dt].split("=");if(1<J.length){var pt=J[0];J=J[1];var gt=pt.split("_");L=2<=gt.length&&gt[1]=="type"?L+(pt+"="+J+"&"):L+(pt+"=redacted&")}}else L=null;else L=C;return"XMLHTTP REQ ("+f+") [attempt "+b+"]: "+c+`
`+l+`
`+L})}function Ed(i,c,l,f,b,C,L){i.info(function(){return"XMLHTTP RESP ("+f+") [ attempt "+b+"]: "+c+`
`+l+`
`+C+" "+L})}function Ue(i,c,l,f){i.info(function(){return"XMLHTTP TEXT ("+c+"): "+Id(i,l)+(f?" "+f:"")})}function Td(i,c){i.info(function(){return"TIMEOUT: "+c})}An.prototype.info=function(){};function Id(i,c){if(!i.g)return c;if(!c)return null;try{var l=JSON.parse(c);if(l){for(i=0;i<l.length;i++)if(Array.isArray(l[i])){var f=l[i];if(!(2>f.length)){var b=f[1];if(Array.isArray(b)&&!(1>b.length)){var C=b[0];if(C!="noop"&&C!="stop"&&C!="close")for(var L=1;L<b.length;L++)b[L]=""}}}}return Bs(l)}catch{return c}}var gr={NO_ERROR:0,gb:1,tb:2,sb:3,nb:4,rb:5,ub:6,Ia:7,TIMEOUT:8,xb:9},sc={lb:"complete",Hb:"success",Ja:"error",Ia:"abort",zb:"ready",Ab:"readystatechange",TIMEOUT:"timeout",vb:"incrementaldata",yb:"progress",ob:"downloadprogress",Pb:"uploadprogress"},zs;function yr(){}S(yr,Us),yr.prototype.g=function(){return new XMLHttpRequest},yr.prototype.i=function(){return{}},zs=new yr;function ne(i,c,l,f){this.j=i,this.i=c,this.l=l,this.R=f||1,this.U=new En(this),this.I=45e3,this.H=null,this.o=!1,this.m=this.A=this.v=this.L=this.F=this.S=this.B=null,this.D=[],this.g=null,this.C=0,this.s=this.u=null,this.X=-1,this.J=!1,this.O=0,this.M=null,this.W=this.K=this.T=this.P=!1,this.h=new ic}function ic(){this.i=null,this.g="",this.h=!1}var oc={},$s={};function Gs(i,c,l){i.L=1,i.v=Er(Ut(c)),i.m=l,i.P=!0,ac(i,null)}function ac(i,c){i.F=Date.now(),_r(i),i.A=Ut(i.v);var l=i.A,f=i.R;Array.isArray(f)||(f=[String(f)]),Ec(l.i,"t",f),i.C=0,l=i.j.J,i.h=new ic,i.g=Bc(i.j,l?c:null,!i.m),0<i.O&&(i.M=new yd(_(i.Y,i,i.g),i.O)),c=i.U,l=i.g,f=i.ca;var b="readystatechange";Array.isArray(b)||(b&&(Ja[0]=b.toString()),b=Ja);for(var C=0;C<b.length;C++){var L=za(l,b[C],f||c.handleEvent,!1,c.h||c);if(!L)break;c.g[L.key]=L}c=i.H?p(i.H):{},i.m?(i.u||(i.u="POST"),c["Content-Type"]="application/x-www-form-urlencoded",i.g.ea(i.A,i.u,i.m,c)):(i.u="GET",i.g.ea(i.A,i.u,null,c)),In(),vd(i.i,i.u,i.A,i.l,i.R,i.m)}ne.prototype.ca=function(i){i=i.target;let c=this.M;c&&qt(i)==3?c.j():this.Y(i)},ne.prototype.Y=function(i){try{if(i==this.g)t:{let gt=qt(this.g);var c=this.g.Ba();let ze=this.g.Z();if(!(3>gt)&&(gt!=3||this.g&&(this.h.h||this.g.oa()||Rc(this.g)))){this.J||gt!=4||c==7||(c==8||0>=ze?In(3):In(2)),Ks(this);var l=this.g.Z();this.X=l;e:if(cc(this)){var f=Rc(this.g);i="";var b=f.length,C=qt(this.g)==4;if(!this.h.i){if(typeof TextDecoder>"u"){ve(this),Sn(this);var L="";break e}this.h.i=new u.TextDecoder}for(c=0;c<b;c++)this.h.h=!0,i+=this.h.i.decode(f[c],{stream:!(C&&c==b-1)});f.length=0,this.h.g+=i,this.C=0,L=this.h.g}else L=this.g.oa();if(this.o=l==200,Ed(this.i,this.u,this.A,this.l,this.R,gt,l),this.o){if(this.T&&!this.K){e:{if(this.g){var Z,dt=this.g;if((Z=dt.g?dt.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!R(Z)){var J=Z;break e}}J=null}if(l=J)Ue(this.i,this.l,l,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,Hs(this,l);else{this.o=!1,this.s=3,Et(12),ve(this),Sn(this);break t}}if(this.P){l=!0;let Rt;for(;!this.J&&this.C<L.length;)if(Rt=bd(this,L),Rt==$s){gt==4&&(this.s=4,Et(14),l=!1),Ue(this.i,this.l,null,"[Incomplete Response]");break}else if(Rt==oc){this.s=4,Et(15),Ue(this.i,this.l,L,"[Invalid Chunk]"),l=!1;break}else Ue(this.i,this.l,Rt,null),Hs(this,Rt);if(cc(this)&&this.C!=0&&(this.h.g=this.h.g.slice(this.C),this.C=0),gt!=4||L.length!=0||this.h.h||(this.s=1,Et(16),l=!1),this.o=this.o&&l,!l)Ue(this.i,this.l,L,"[Invalid Chunked Response]"),ve(this),Sn(this);else if(0<L.length&&!this.W){this.W=!0;var pt=this.j;pt.g==this&&pt.ba&&!pt.M&&(pt.j.info("Great, no buffering proxy detected. Bytes received: "+L.length),Zs(pt),pt.M=!0,Et(11))}}else Ue(this.i,this.l,L,null),Hs(this,L);gt==4&&ve(this),this.o&&!this.J&&(gt==4?Oc(this.j,this):(this.o=!1,_r(this)))}else qd(this.g),l==400&&0<L.indexOf("Unknown SID")?(this.s=3,Et(12)):(this.s=0,Et(13)),ve(this),Sn(this)}}}catch{}finally{}};function cc(i){return i.g?i.u=="GET"&&i.L!=2&&i.j.Ca:!1}function bd(i,c){var l=i.C,f=c.indexOf(`
`,l);return f==-1?$s:(l=Number(c.substring(l,f)),isNaN(l)?oc:(f+=1,f+l>c.length?$s:(c=c.slice(f,f+l),i.C=f+l,c)))}ne.prototype.cancel=function(){this.J=!0,ve(this)};function _r(i){i.S=Date.now()+i.I,uc(i,i.I)}function uc(i,c){if(i.B!=null)throw Error("WatchDog timer not null");i.B=bn(_(i.ba,i),c)}function Ks(i){i.B&&(u.clearTimeout(i.B),i.B=null)}ne.prototype.ba=function(){this.B=null;let i=Date.now();0<=i-this.S?(Td(this.i,this.A),this.L!=2&&(In(),Et(17)),ve(this),this.s=2,Sn(this)):uc(this,this.S-i)};function Sn(i){i.j.G==0||i.J||Oc(i.j,i)}function ve(i){Ks(i);var c=i.M;c&&typeof c.ma=="function"&&c.ma(),i.M=null,Xa(i.U),i.g&&(c=i.g,i.g=null,c.abort(),c.ma())}function Hs(i,c){try{var l=i.j;if(l.G!=0&&(l.g==i||Ws(l.h,i))){if(!i.K&&Ws(l.h,i)&&l.G==3){try{var f=l.Da.g.parse(c)}catch{f=null}if(Array.isArray(f)&&f.length==3){var b=f;if(b[0]==0){t:if(!l.u){if(l.g)if(l.g.F+3e3<i.F)Sr(l),br(l);else break t;Ys(l),Et(18)}}else l.za=b[1],0<l.za-l.T&&37500>b[2]&&l.F&&l.v==0&&!l.C&&(l.C=bn(_(l.Za,l),6e3));if(1>=dc(l.h)&&l.ca){try{l.ca()}catch{}l.ca=void 0}}else Te(l,11)}else if((i.K||l.g==i)&&Sr(l),!R(c))for(b=l.Da.g.parse(c),c=0;c<b.length;c++){let J=b[c];if(l.T=J[0],J=J[1],l.G==2)if(J[0]=="c"){l.K=J[1],l.ia=J[2];let pt=J[3];pt!=null&&(l.la=pt,l.j.info("VER="+l.la));let gt=J[4];gt!=null&&(l.Aa=gt,l.j.info("SVER="+l.Aa));let ze=J[5];ze!=null&&typeof ze=="number"&&0<ze&&(f=1.5*ze,l.L=f,l.j.info("backChannelRequestTimeoutMs_="+f)),f=l;let Rt=i.g;if(Rt){let Rr=Rt.g?Rt.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(Rr){var C=f.h;C.g||Rr.indexOf("spdy")==-1&&Rr.indexOf("quic")==-1&&Rr.indexOf("h2")==-1||(C.j=C.l,C.g=new Set,C.h&&(Qs(C,C.h),C.h=null))}if(f.D){let ti=Rt.g?Rt.g.getResponseHeader("X-HTTP-Session-Id"):null;ti&&(f.ya=ti,tt(f.I,f.D,ti))}}l.G=3,l.l&&l.l.ua(),l.ba&&(l.R=Date.now()-i.F,l.j.info("Handshake RTT: "+l.R+"ms")),f=l;var L=i;if(f.qa=Fc(f,f.J?f.ia:null,f.W),L.K){fc(f.h,L);var Z=L,dt=f.L;dt&&(Z.I=dt),Z.B&&(Ks(Z),_r(Z)),f.g=L}else Nc(f);0<l.i.length&&Ar(l)}else J[0]!="stop"&&J[0]!="close"||Te(l,7);else l.G==3&&(J[0]=="stop"||J[0]=="close"?J[0]=="stop"?Te(l,7):Xs(l):J[0]!="noop"&&l.l&&l.l.ta(J),l.v=0)}}In(4)}catch{}}var Ad=class{constructor(i,c){this.g=i,this.map=c}};function lc(i){this.l=i||10,u.PerformanceNavigationTiming?(i=u.performance.getEntriesByType("navigation"),i=0<i.length&&(i[0].nextHopProtocol=="hq"||i[0].nextHopProtocol=="h2")):i=!!(u.chrome&&u.chrome.loadTimes&&u.chrome.loadTimes()&&u.chrome.loadTimes().wasFetchedViaSpdy),this.j=i?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}function hc(i){return i.h?!0:i.g?i.g.size>=i.j:!1}function dc(i){return i.h?1:i.g?i.g.size:0}function Ws(i,c){return i.h?i.h==c:i.g?i.g.has(c):!1}function Qs(i,c){i.g?i.g.add(c):i.h=c}function fc(i,c){i.h&&i.h==c?i.h=null:i.g&&i.g.has(c)&&i.g.delete(c)}lc.prototype.cancel=function(){if(this.i=mc(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&this.g.size!==0){for(let i of this.g.values())i.cancel();this.g.clear()}};function mc(i){if(i.h!=null)return i.i.concat(i.h.D);if(i.g!=null&&i.g.size!==0){let c=i.i;for(let l of i.g.values())c=c.concat(l.D);return c}return D(i.i)}function Sd(i){if(i.V&&typeof i.V=="function")return i.V();if(typeof Map<"u"&&i instanceof Map||typeof Set<"u"&&i instanceof Set)return Array.from(i.values());if(typeof i=="string")return i.split("");if(h(i)){for(var c=[],l=i.length,f=0;f<l;f++)c.push(i[f]);return c}c=[],l=0;for(f in i)c[l++]=i[f];return c}function Cd(i){if(i.na&&typeof i.na=="function")return i.na();if(!i.V||typeof i.V!="function"){if(typeof Map<"u"&&i instanceof Map)return Array.from(i.keys());if(!(typeof Set<"u"&&i instanceof Set)){if(h(i)||typeof i=="string"){var c=[];i=i.length;for(var l=0;l<i;l++)c.push(l);return c}c=[],l=0;for(let f in i)c[l++]=f;return c}}}function pc(i,c){if(i.forEach&&typeof i.forEach=="function")i.forEach(c,void 0);else if(h(i)||typeof i=="string")Array.prototype.forEach.call(i,c,void 0);else for(var l=Cd(i),f=Sd(i),b=f.length,C=0;C<b;C++)c.call(void 0,f[C],l&&l[C],i)}var gc=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function Rd(i,c){if(i){i=i.split("&");for(var l=0;l<i.length;l++){var f=i[l].indexOf("="),b=null;if(0<=f){var C=i[l].substring(0,f);b=i[l].substring(f+1)}else C=i[l];c(C,b?decodeURIComponent(b.replace(/\+/g," ")):"")}}}function Ee(i){if(this.g=this.o=this.j="",this.s=null,this.m=this.l="",this.h=!1,i instanceof Ee){this.h=i.h,wr(this,i.j),this.o=i.o,this.g=i.g,vr(this,i.s),this.l=i.l;var c=i.i,l=new xn;l.i=c.i,c.g&&(l.g=new Map(c.g),l.h=c.h),yc(this,l),this.m=i.m}else i&&(c=String(i).match(gc))?(this.h=!1,wr(this,c[1]||"",!0),this.o=Cn(c[2]||""),this.g=Cn(c[3]||"",!0),vr(this,c[4]),this.l=Cn(c[5]||"",!0),yc(this,c[6]||"",!0),this.m=Cn(c[7]||"")):(this.h=!1,this.i=new xn(null,this.h))}Ee.prototype.toString=function(){var i=[],c=this.j;c&&i.push(Rn(c,_c,!0),":");var l=this.g;return(l||c=="file")&&(i.push("//"),(c=this.o)&&i.push(Rn(c,_c,!0),"@"),i.push(encodeURIComponent(String(l)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),l=this.s,l!=null&&i.push(":",String(l))),(l=this.l)&&(this.g&&l.charAt(0)!="/"&&i.push("/"),i.push(Rn(l,l.charAt(0)=="/"?Dd:Pd,!0))),(l=this.i.toString())&&i.push("?",l),(l=this.m)&&i.push("#",Rn(l,Nd)),i.join("")};function Ut(i){return new Ee(i)}function wr(i,c,l){i.j=l?Cn(c,!0):c,i.j&&(i.j=i.j.replace(/:$/,""))}function vr(i,c){if(c){if(c=Number(c),isNaN(c)||0>c)throw Error("Bad port number "+c);i.s=c}else i.s=null}function yc(i,c,l){c instanceof xn?(i.i=c,kd(i.i,i.h)):(l||(c=Rn(c,Vd)),i.i=new xn(c,i.h))}function tt(i,c,l){i.i.set(c,l)}function Er(i){return tt(i,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),i}function Cn(i,c){return i?c?decodeURI(i.replace(/%25/g,"%2525")):decodeURIComponent(i):""}function Rn(i,c,l){return typeof i=="string"?(i=encodeURI(i).replace(c,xd),l&&(i=i.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),i):null}function xd(i){return i=i.charCodeAt(0),"%"+(i>>4&15).toString(16)+(i&15).toString(16)}var _c=/[#\/\?@]/g,Pd=/[#\?:]/g,Dd=/[#\?]/g,Vd=/[#\?@]/g,Nd=/#/g;function xn(i,c){this.h=this.g=null,this.i=i||null,this.j=!!c}function re(i){i.g||(i.g=new Map,i.h=0,i.i&&Rd(i.i,function(c,l){i.add(decodeURIComponent(c.replace(/\+/g," ")),l)}))}n=xn.prototype,n.add=function(i,c){re(this),this.i=null,i=qe(this,i);var l=this.g.get(i);return l||this.g.set(i,l=[]),l.push(c),this.h+=1,this};function wc(i,c){re(i),c=qe(i,c),i.g.has(c)&&(i.i=null,i.h-=i.g.get(c).length,i.g.delete(c))}function vc(i,c){return re(i),c=qe(i,c),i.g.has(c)}n.forEach=function(i,c){re(this),this.g.forEach(function(l,f){l.forEach(function(b){i.call(c,b,f,this)},this)},this)},n.na=function(){re(this);let i=Array.from(this.g.values()),c=Array.from(this.g.keys()),l=[];for(let f=0;f<c.length;f++){let b=i[f];for(let C=0;C<b.length;C++)l.push(c[f])}return l},n.V=function(i){re(this);let c=[];if(typeof i=="string")vc(this,i)&&(c=c.concat(this.g.get(qe(this,i))));else{i=Array.from(this.g.values());for(let l=0;l<i.length;l++)c=c.concat(i[l])}return c},n.set=function(i,c){return re(this),this.i=null,i=qe(this,i),vc(this,i)&&(this.h-=this.g.get(i).length),this.g.set(i,[c]),this.h+=1,this},n.get=function(i,c){return i?(i=this.V(i),0<i.length?String(i[0]):c):c};function Ec(i,c,l){wc(i,c),0<l.length&&(i.i=null,i.g.set(qe(i,c),D(l)),i.h+=l.length)}n.toString=function(){if(this.i)return this.i;if(!this.g)return"";let i=[],c=Array.from(this.g.keys());for(var l=0;l<c.length;l++){var f=c[l];let C=encodeURIComponent(String(f)),L=this.V(f);for(f=0;f<L.length;f++){var b=C;L[f]!==""&&(b+="="+encodeURIComponent(String(L[f]))),i.push(b)}}return this.i=i.join("&")};function qe(i,c){return c=String(c),i.j&&(c=c.toLowerCase()),c}function kd(i,c){c&&!i.j&&(re(i),i.i=null,i.g.forEach(function(l,f){var b=f.toLowerCase();f!=b&&(wc(this,f),Ec(this,b,l))},i)),i.j=c}function Od(i,c){let l=new An;if(u.Image){let f=new Image;f.onload=I(se,l,"TestLoadImage: loaded",!0,c,f),f.onerror=I(se,l,"TestLoadImage: error",!1,c,f),f.onabort=I(se,l,"TestLoadImage: abort",!1,c,f),f.ontimeout=I(se,l,"TestLoadImage: timeout",!1,c,f),u.setTimeout(function(){f.ontimeout&&f.ontimeout()},1e4),f.src=i}else c(!1)}function Ld(i,c){let l=new An,f=new AbortController,b=setTimeout(()=>{f.abort(),se(l,"TestPingServer: timeout",!1,c)},1e4);fetch(i,{signal:f.signal}).then(C=>{clearTimeout(b),C.ok?se(l,"TestPingServer: ok",!0,c):se(l,"TestPingServer: server error",!1,c)}).catch(()=>{clearTimeout(b),se(l,"TestPingServer: error",!1,c)})}function se(i,c,l,f,b){try{b&&(b.onload=null,b.onerror=null,b.onabort=null,b.ontimeout=null),f(l)}catch{}}function Md(){this.g=new wd}function Fd(i,c,l){let f=l||"";try{pc(i,function(b,C){let L=b;d(b)&&(L=Bs(b)),c.push(f+C+"="+encodeURIComponent(L))})}catch(b){throw c.push(f+"type="+encodeURIComponent("_badmap")),b}}function Pn(i){this.l=i.Ub||null,this.j=i.eb||!1}S(Pn,Us),Pn.prototype.g=function(){return new Tr(this.l,this.j)},Pn.prototype.i=function(i){return function(){return i}}({});function Tr(i,c){mt.call(this),this.D=i,this.o=c,this.m=void 0,this.status=this.readyState=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.u=new Headers,this.h=null,this.B="GET",this.A="",this.g=!1,this.v=this.j=this.l=null}S(Tr,mt),n=Tr.prototype,n.open=function(i,c){if(this.readyState!=0)throw this.abort(),Error("Error reopening a connection");this.B=i,this.A=c,this.readyState=1,Vn(this)},n.send=function(i){if(this.readyState!=1)throw this.abort(),Error("need to call open() first. ");this.g=!0;let c={headers:this.u,method:this.B,credentials:this.m,cache:void 0};i&&(c.body=i),(this.D||u).fetch(new Request(this.A,c)).then(this.Sa.bind(this),this.ga.bind(this))},n.abort=function(){this.response=this.responseText="",this.u=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&this.readyState!=4&&(this.g=!1,Dn(this)),this.readyState=0},n.Sa=function(i){if(this.g&&(this.l=i,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=i.headers,this.readyState=2,Vn(this)),this.g&&(this.readyState=3,Vn(this),this.g)))if(this.responseType==="arraybuffer")i.arrayBuffer().then(this.Qa.bind(this),this.ga.bind(this));else if(typeof u.ReadableStream<"u"&&"body"in i){if(this.j=i.body.getReader(),this.o){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.v=new TextDecoder;Tc(this)}else i.text().then(this.Ra.bind(this),this.ga.bind(this))};function Tc(i){i.j.read().then(i.Pa.bind(i)).catch(i.ga.bind(i))}n.Pa=function(i){if(this.g){if(this.o&&i.value)this.response.push(i.value);else if(!this.o){var c=i.value?i.value:new Uint8Array(0);(c=this.v.decode(c,{stream:!i.done}))&&(this.response=this.responseText+=c)}i.done?Dn(this):Vn(this),this.readyState==3&&Tc(this)}},n.Ra=function(i){this.g&&(this.response=this.responseText=i,Dn(this))},n.Qa=function(i){this.g&&(this.response=i,Dn(this))},n.ga=function(){this.g&&Dn(this)};function Dn(i){i.readyState=4,i.l=null,i.j=null,i.v=null,Vn(i)}n.setRequestHeader=function(i,c){this.u.append(i,c)},n.getResponseHeader=function(i){return this.h&&this.h.get(i.toLowerCase())||""},n.getAllResponseHeaders=function(){if(!this.h)return"";let i=[],c=this.h.entries();for(var l=c.next();!l.done;)l=l.value,i.push(l[0]+": "+l[1]),l=c.next();return i.join(`\r
...
`+n.stack),t}function Al(n){return function(e,r){if(typeof e!="object"||e===null)return!1;let s=e;for(let o of r)if(o in s&&typeof s[o]=="function")return!0;return!1}(n,["next","error","complete"])}var mn=class extends fn{constructor(t,e,r,s){super(t,e,r,s),this.type="firestore",this._queue=new ys,this._persistenceKey=s?.name||"[DEFAULT]"}async _terminate(){if(this._firestoreClient){let t=this._firestoreClient.terminate();this._queue=new ys(t),this._firestoreClient=void 0,await t}}};function Gh(n,t){let e=typeof n=="object"?n:xu(),r=typeof n=="string"?n:t||Qr,s=Su(e,"firestore").getImmediate({identifier:r});if(!s._initialized){let o=au("firestore");o&&cg(s,...o)}return s}function Kh(n){if(n._terminated)throw new B(N.FAILED_PRECONDITION,"The client has already been terminated.");return n._firestoreClient||lg(n),n._firestoreClient}function lg(n){var t,e,r;let s=n._freezeSettings(),o=function(u,h,d,m){return new Bi(u,h,d,m.host,m.ssl,m.experimentalForceLongPolling,m.experimentalAutoDetectLongPolling,zh(m.experimentalLongPollingOptions),m.useFetchStreams,m.isUsingEmulator)}(n._databaseId,((t=n._app)===null||t===void 0?void 0:t.options.appId)||"",n._persistenceKey,s);n._componentsProvider||!((e=s.localCache)===null||e===void 0)&&e._offlineComponentProvider&&(!((r=s.localCache)===null||r===void 0)&&r._onlineComponentProvider)&&(n._componentsProvider={_offline:s.localCache._offlineComponentProvider,_online:s.localCache._onlineComponentProvider}),n._firestoreClient=new ca(n._authCredentials,n._appCheckCredentials,n._queue,o,n._componentsProvider&&function(u){let h=u?._online.build();return{_offline:u?._offline.build(h),_online:h}}(n._componentsProvider))}var le=class n{constructor(t){this._byteString=t}static fromBase64String(t){try{return new n(wt.fromBase64String(t))}catch(e){throw new B(N.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new n(wt.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}toJSON(){return{type:n._jsonSchemaVersion,bytes:this.toBase64()}}static fromJSON(t){if(cr(t,n._jsonSchema))return n.fromBase64String(t.bytes)}};le._jsonSchemaVersion="firestore/bytes/1.0",le._jsonSchema={type:ct("string",le._jsonSchemaVersion),bytes:ct("string")};var ir=class{constructor(...t){for(let e=0;e<t.length;++e)if(t[e].length===0)throw new B(N.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new At(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}};var or=class{constructor(t){this._methodName=t}};var he=class n{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new B(N.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new B(N.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}_compareTo(t){return G(this._lat,t._lat)||G(this._long,t._long)}toJSON(){return{latitude:this._lat,longitude:this._long,type:n._jsonSchemaVersion}}static fromJSON(t){if(cr(t,n._jsonSchema))return new n(t.latitude,t.longitude)}};he._jsonSchemaVersion="firestore/geoPoint/1.0",he._jsonSchema={type:ct("string",he._jsonSchemaVersion),latitude:ct("number"),longitude:ct("number")};var de=class n{constructor(t){this._values=(t||[]).map(e=>e)}toArray(){return this._values.map(t=>t)}isEqual(t){return function(r,s){if(r.length!==s.length)return!1;for(let o=0;o<r.length;++o)if(r[o]!==s[o])return!1;return!0}(this._values,t._values)}toJSON(){return{type:n._jsonSchemaVersion,vectorValues:this._values}}static fromJSON(t){if(cr(t,n._jsonSchema)){if(Array.isArray(t.vectorValues)&&t.vectorValues.every(e=>typeof e=="number"))return new n(t.vectorValues);throw new B(N.INVALID_ARGUMENT,"Expected 'vectorValues' field to be a number array")}}};de._jsonSchemaVersion="firestore/vectorValue/1.0",de._jsonSchema={type:ct("string",de._jsonSchemaVersion),vectorValues:ct("object")};var hg=/^__.*__$/,ua=class{constructor(t,e,r){this.data=t,this.fieldMask=e,this.fieldTransforms=r}toMutation(t,e){return this.fieldMask!==null?new te(t,this.data,this.fieldMask,e,this.fieldTransforms):new Oe(t,this.data,e,this.fieldTransforms)}};function Hh(n){switch(n){case 0:case 2:case 1:return!0;case 3:case 4:return!1;default:throw j(40011,{Ec:n})}}var la=class n{constructor(t,e,r,s,o,a){this.settings=t,this.databaseId=e,this.serializer=r,this.ignoreUndefinedProperties=s,o===void 0&&this.Ac(),this.fieldTransforms=o||[],this.fieldMask=a||[]}get path(){return this.settings.path}get Ec(){return this.settings.Ec}Rc(t){return new n(Object.assign(Object.assign({},this.settings),t),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Vc(t){var e;let r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.Rc({path:r,mc:!1});return s.fc(t),s}gc(t){var e;let r=(e=this.path)===null||e===void 0?void 0:e.child(t),s=this.Rc({path:r,mc:!1});return s.Ac(),s}yc(t){return this.Rc({path:void 0,mc:!0})}wc(t){return _s(t,this.settings.methodName,this.settings.Sc||!1,this.path,this.settings.bc)}contains(t){return this.fieldMask.find(e=>t.isPrefixOf(e))!==void 0||this.fieldTransforms.find(e=>t.isPrefixOf(e.field))!==void 0}Ac(){if(this.path)for(let t=0;t<this.path.length;t++)this.fc(this.path.get(t))}fc(t){if(t.length===0)throw this.wc("Document fields must not be empty");if(Hh(this.Ec)&&hg.test(t))throw this.wc('Document fields cannot begin and end with "__"')}},ha=class{constructor(t,e,r){this.databaseId=t,this.ignoreUndefinedProperties=e,this.serializer=r||Cs(t)}Dc(t,e,r,s=!1){return new la({Ec:t,methodName:e,bc:r,path:At.emptyPath(),mc:!1,Sc:s},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}};function Wh(n){let t=n._freezeSettings(),e=Cs(n._databaseId);return new ha(n._databaseId,!!t.ignoreUndefinedProperties,e)}function dg(n,t,e,r,s,o={}){let a=n.Dc(o.merge||o.mergeFields?2:0,t,e,s);Xh("Data must be an object, but it was:",a,r);let u=Qh(r,a),h,d;if(o.merge)h=new Ot(a.fieldMask),d=a.fieldTransforms;else if(o.mergeFields){let m=[];for(let g of o.mergeFields){let _=mg(t,g,e);if(!a.contains(_))throw new B(N.INVALID_ARGUMENT,`Field '${_}' is specified in your field mask but missing from your input data.`);gg(m,_)||m.push(_)}h=new Ot(m),d=a.fieldTransforms.filter(g=>h.covers(g.field))}else h=null,d=a.fieldTransforms;return new ua(new xt(u),h,d)}var da=class n extends or{_toFieldTransform(t){return new to(t.path,new Ve)}isEqual(t){return t instanceof n}};function fg(n,t,e,r=!1){return Ba(e,n.Dc(r?4:3,t))}function Ba(n,t){if(Jh(n=oe(n)))return Xh("Unsupported field value:",t,n),Qh(n,t);if(n instanceof or)return function(r,s){if(!Hh(s.Ec))throw s.wc(`${r._methodName}() can only be used with update() and set()`);if(!s.path)throw s.wc(`${r._methodName}() is not currently supported inside arrays`);let o=r._toFieldTransform(s);o&&s.fieldTransforms.push(o)}(n,t),null;if(n===void 0&&t.ignoreUndefinedProperties)return null;if(t.path&&t.fieldMask.push(t.path),n instanceof Array){if(t.settings.mc&&t.Ec!==4)throw t.wc("Nested arrays are not supported");return function(r,s){let o=[],a=0;for(let u of r){let h=Ba(u,s.yc(a));h==null&&(h={nullValue:"NULL_VALUE"}),o.push(h),a++}return{arrayValue:{values:o}}}(n,t)}return function(r,s){if((r=oe(r))===null)return{nullValue:"NULL_VALUE"};if(typeof r=="number")return Jm(s.serializer,r);if(typeof r=="boolean")return{booleanValue:r};if(typeof r=="string")return{stringValue:r};if(r instanceof Date){let o=ut.fromDate(r);return{timestampValue:rs(s.serializer,o)}}if(r instanceof ut){let o=new ut(r.seconds,1e3*Math.floor(r.nanoseconds/1e3));return{timestampValue:rs(s.serializer,o)}}if(r instanceof he)return{geoPointValue:{latitude:r.latitude,longitude:r.longitude}};if(r instanceof le)return{bytesValue:vh(s.serializer,r._byteString)};if(r instanceof _t){let o=s.databaseId,a=r.firestore._databaseId;if(!a.isEqual(o))throw s.wc(`Document reference is for database ${a.projectId}/${a.database} but should be for database ${o.projectId}/${o.database}`);return{referenceValue:Ra(r.firestore._databaseId||s.databaseId,r._key.path)}}if(r instanceof de)return function(a,u){return{mapValue:{fields:{[Ea]:{stringValue:Ta},[rn]:{arrayValue:{values:a.toArray().map(d=>{if(typeof d!="number")throw u.wc("VectorValues must only contain numeric values.");return Ca(u.serializer,d)})}}}}}}(r,s);throw s.wc(`Unsupported field value: ${Ts(r)}`)}(n,t)}function Qh(n,t){let e={};return Kl(n)?t.path&&t.path.length>0&&t.fieldMask.push(t.path):Fe(n,(r,s)=>{let o=Ba(s,t.Vc(r));o!=null&&(e[r]=o)}),{mapValue:{fields:e}}}function Jh(n){return!(typeof n!="object"||n===null||n instanceof Array||n instanceof Date||n instanceof ut||n instanceof he||n instanceof le||n instanceof _t||n instanceof or||n instanceof de)}function Xh(n,t,e){if(!Jh(e)||!Dl(e)){let r=Ts(e);throw r==="an object"?t.wc(n+" a custom object"):t.wc(n+" "+r)}}function mg(n,t,e){if((t=oe(t))instanceof ir)return t._internalPath;if(typeof t=="string")return Yh(n,t);throw _s("Field path arguments must be of type string or ",n,!1,void 0,e)}var pg=new RegExp("[~\\*/\\[\\]]");function Yh(n,t,e){if(t.search(pg)>=0)throw _s(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,n,!1,void 0,e);try{return new ir(...t.split("."))._internalPath}catch{throw _s(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,n,!1,void 0,e)}}function _s(n,t,e,r,s){let o=r&&!r.isEmpty(),a=s!==void 0,u=`Function ${t}() called with invalid data`;e&&(u+=" (via `toFirestore()`)"),u+=". ";let h="";return(o||a)&&(h+=" (found",o&&(h+=` in field ${r}`),a&&(h+=` in document ${s}`),h+=")"),new B(N.INVALID_ARGUMENT,u+n+h)}function gg(n,t){return n.some(e=>e.isEqual(t))}var ws=class{constructor(t,e,r,s,o){this._firestore=t,this._userDataWriter=e,this._key=r,this._document=s,this._converter=o}get id(){return this._key.path.lastSegment()}get ref(){return new _t(this._firestore,this._converter,this._key)}exists(){return this._document!==null}data(){if(this._document){if(this._converter){let t=new fa(this._firestore,this._userDataWriter,this._key,this._document,null);return this._converter.fromFirestore(t)}return this._userDataWriter.convertValue(this._document.data.value)}}get(t){if(this._document){let e=this._document.data.field(Ua("DocumentSnapshot.get",t));if(e!==null)return this._userDataWriter.convertValue(e)}}},fa=class extends ws{data(){return super.data()}};function Ua(n,t){return typeof t=="string"?Yh(n,t):t instanceof ir?t._internalPath:t._delegate._internalPath}function yg(n){if(n.limitType==="L"&&n.explicitOrderBy.length===0)throw new B(N.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}var ar=class{},vs=class extends ar{};function Zh(n,t,...e){let r=[];t instanceof ar&&r.push(t),r=r.concat(e),function(o){let a=o.filter(h=>h instanceof pa).length,u=o.filter(h=>h instanceof ma).length;if(a>1||a>0&&u>0)throw new B(N.INVALID_ARGUMENT,"InvalidQuery. When using composite filters, you cannot use more than one filter at the top level. Consider nesting the multiple filters within an `and(...)` statement. For example: change `query(query, where(...), or(...))` to `query(query, and(where(...), or(...)))`.")}(r);for(let s of r)n=s._apply(n);return n}var ma=class n extends vs{constructor(t,e,r){super(),this._field=t,this._op=e,this._value=r,this.type="where"}static _create(t,e,r){return new n(t,e,r)}_apply(t){let e=this._parse(t);return ed(t._query,e),new Me(t.firestore,t.converter,Yi(t._query,e))}_parse(t){let e=Wh(t.firestore);return function(o,a,u,h,d,m,g){let _;if(d.isKeyField()){if(m==="array-contains"||m==="array-contains-any")throw new B(N.INVALID_ARGUMENT,`Invalid Query. You can't perform '${m}' queries on documentId().`);if(m==="in"||m==="not-in"){Cl(g,m);let S=[];for(let D of g)S.push(Sl(h,o,D));_={arrayValue:{values:S}}}else _=Sl(h,o,g)}else m!=="in"&&m!=="not-in"&&m!=="array-contains-any"||Cl(g,m),_=fg(u,a,g,m==="in"||m==="not-in");return at.create(d,m,_)}(t._query,"where",e,t.firestore._databaseId,this._field,this._op,this._value)}};var pa=class n extends ar{constructor(t,e){super(),this.type=t,this._queryConstraints=e}static _create(t,e){return new n(t,e)}_parse(t){let e=this._queryConstraints.map(r=>r._parse(t)).filter(r=>r.getFilters().length>0);return e.length===1?e[0]:Dt.create(e,this._getOperator())}_apply(t){let e=this._parse(t);return e.getFilters().length===0?t:(function(s,o){let a=s,u=o.getFlattenedFilters();for(let h of u)ed(a,h),a=Yi(a,h)}(t._query,e),new Me(t.firestore,t.converter,Yi(t._query,e)))}_getQueryConstraints(){return this._queryConstraints}_getOperator(){return this.type==="and"?"and":"or"}};var ga=class n extends vs{constructor(t,e){super(),this._field=t,this._direction=e,this.type="orderBy"}static _create(t,e){return new n(t,e)}_apply(t){let e=function(s,o,a){if(s.startAt!==null)throw new B(N.INVALID_ARGUMENT,"Invalid query. You must not call startAt() or startAfter() before calling orderBy().");if(s.endAt!==null)throw new B(N.INVALID_ARGUMENT,"Invalid query. You must not call endAt() or endBefore() before calling orderBy().");return new De(o,a)}(t._query,this._field,this._direction);return new Me(t.firestore,t.converter,function(s,o){let a=s.explicitOrderBy.concat([o]);return new pe(s.path,s.collectionGroup,a,s.filters.slice(),s.limit,s.limitType,s.startAt,s.endAt)}(t._query,e))}};function td(n,t="asc"){let e=t,r=Ua("orderBy",n);return ga._create(r,e)}function Sl(n,t,e){if(typeof(e=oe(e))=="string"){if(e==="")throw new B(N.INVALID_ARGUMENT,"Invalid query. When querying with documentId(), you must provide a valid document ID, but it was an empty string.");if(!oh(t)&&e.indexOf("/")!==-1)throw new B(N.INVALID_ARGUMENT,`Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '${e}' contains a '/' character.`);let r=t.path.child(nt.fromString(e));if(!q.isDocumentKey(r))throw new B(N.INVALID_ARGUMENT,`Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '${r}' is not because it has an odd number of segments (${r.length}).`);return Ku(n,new q(r))}if(e instanceof _t)return Ku(n,e._key);throw new B(N.INVALID_ARGUMENT,`Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: ${Ts(e)}.`)}function Cl(n,t){if(!Array.isArray(n)||n.length===0)throw new B(N.INVALID_ARGUMENT,`Invalid Query. A non-empty array is required for '${t.toString()}' filters.`)}function ed(n,t){let e=function(s,o){for(let a of s)for(let u of a.getFlattenedFilters())if(o.indexOf(u.op)>=0)return u.op;return null}(n.filters,function(s){switch(s){case"!=":return["!=","not-in"];case"array-contains-any":case"in":return["not-in"];case"not-in":return["array-contains-any","in","not-in","!="];default:return[]}}(t.op));if(e!==null)throw e===t.op?new B(N.INVALID_ARGUMENT,`Invalid query. You cannot use more than one '${t.op.toString()}' filter.`):new B(N.INVALID_ARGUMENT,`Invalid query. You cannot use '${t.op.toString()}' filters with '${e.toString()}' filters.`)}var ya=class{convertValue(t,e="none"){switch(me(t)){case 0:return null;case 1:return t.booleanValue;case 2:return et(t.integerValue||t.doubleValue);case 3:return this.convertTimestamp(t.timestampValue);case 4:return this.convertServerTimestamp(t,e);case 5:return t.stringValue;case 6:return this.convertBytes(Xt(t.bytesValue));case 7:return this.convertReference(t.referenceValue);case 8:return this.convertGeoPoint(t.geoPointValue);case 9:return this.convertArray(t.arrayValue,e);case 11:return this.convertObject(t.mapValue,e);case 10:return this.convertVectorValue(t.mapValue);default:throw j(62114,{value:t})}}convertObject(t,e){return this.convertObjectMap(t.fields,e)}convertObjectMap(t,e="none"){let r={};return Fe(t,(s,o)=>{r[s]=this.convertValue(o,e)}),r}convertVectorValue(t){var e,r,s;let o=(s=(r=(e=t.fields)===null||e===void 0?void 0:e[rn].arrayValue)===null||r===void 0?void 0:r.values)===null||s===void 0?void 0:s.map(a=>et(a.doubleValue));return new de(o)}convertGeoPoint(t){return new he(et(t.latitude),et(t.longitude))}convertArray(t,e){return(t.values||[]).map(r=>this.convertValue(r,e))}convertServerTimestamp(t,e){switch(e){case"previous":let r=bs(t);return r==null?null:this.convertValue(r,e);case"estimate":return this.convertTimestamp(Yn(t));default:return null}}convertTimestamp(t){let e=Jt(t);return new ut(e.seconds,e.nanos)}convertDocumentKey(t,e){let r=nt.fromString(t);Y(Sh(r),9688,{name:t});let s=new Jr(r.get(1),r.get(3)),o=new q(r.popFirst(5));return s.isEqual(e)||Qt(`Document ${o} contains a document reference within a different database (${s.projectId}/${s.database}) which is not supported. It will be treated as a reference in the current database (${e.projectId}/${e.database}) instead.`),o}};function _g(n,t,e){let r;return r=n?e&&(e.merge||e.mergeFields)?n.toFirestore(t,e):n.toFirestore(t):t,r}var Se=class{constructor(t,e){this.hasPendingWrites=t,this.fromCache=e}isEqual(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache}},Re=class n extends ws{constructor(t,e,r,s,o,a){super(t,e,r,s,a),this._firestore=t,this._firestoreImpl=t,this.metadata=o}exists(){return super.exists()}data(t={}){if(this._document){if(this._converter){let e=new Ze(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,null);return this._converter.fromFirestore(e,t)}return this._userDataWriter.convertValue(this._document.data.value,t.serverTimestamps)}}get(t,e={}){if(this._document){let r=this._document.data.field(Ua("DocumentSnapshot.get",t));if(r!==null)return this._userDataWriter.convertValue(r,e.serverTimestamps)}}toJSON(){if(this.metadata.hasPendingWrites)throw new B(N.FAILED_PRECONDITION,"DocumentSnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");let t=this._document,e={};return e.type=n._jsonSchemaVersion,e.bundle="",e.bundleSource="DocumentSnapshot",e.bundleName=this._key.toString(),!t||!t.isValidDocument()||!t.isFoundDocument()?e:(this._userDataWriter.convertObjectMap(t.data.value.mapValue.fields,"previous"),e.bundle=(this._firestore,this.ref.path,"NOT SUPPORTED"),e)}};Re._jsonSchemaVersion="firestore/documentSnapshot/1.0",Re._jsonSchema={type:ct("string",Re._jsonSchemaVersion),bundleSource:ct("string","DocumentSnapshot"),bundleName:ct("string"),bundle:ct("string")};var Ze=class extends Re{data(t={}){return super.data(t)}},tn=class n{constructor(t,e,r,s){this._firestore=t,this._userDataWriter=e,this._snapshot=s,this.metadata=new Se(s.hasPendingWrites,s.fromCache),this.query=r}get docs(){let t=[];return this.forEach(e=>t.push(e)),t}get size(){return this._snapshot.docs.size}get empty(){return this.size===0}forEach(t,e){this._snapshot.docs.forEach(r=>{t.call(e,new Ze(this._firestore,this._userDataWriter,r.key,r,new Se(this._snapshot.mutatedKeys.has(r.key),this._snapshot.fromCache),this.query.converter))})}docChanges(t={}){let e=!!t.includeMetadataChanges;if(e&&this._snapshot.excludesMetadataChanges)throw new B(N.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===e||(this._cachedChanges=function(s,o){if(s._snapshot.oldDocs.isEmpty()){let a=0;return s._snapshot.docChanges.map(u=>{let h=new Ze(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Se(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter);return u.doc,{type:"added",doc:h,oldIndex:-1,newIndex:a++}})}{let a=s._snapshot.oldDocs;return s._snapshot.docChanges.filter(u=>o||u.type!==3).map(u=>{let h=new Ze(s._firestore,s._userDataWriter,u.doc.key,u.doc,new Se(s._snapshot.mutatedKeys.has(u.doc.key),s._snapshot.fromCache),s.query.converter),d=-1,m=-1;return u.type!==0&&(d=a.indexOf(u.doc.key),a=a.delete(u.doc.key)),u.type!==1&&(a=a.add(u.doc),m=a.indexOf(u.doc.key)),{type:wg(u.type),doc:h,oldIndex:d,newIndex:m}})}}(this,e),this._cachedChangesIncludeMetadataChanges=e),this._cachedChanges}toJSON(){if(this.metadata.hasPendingWrites)throw new B(N.FAILED_PRECONDITION,"QuerySnapshot.toJSON() attempted to serialize a document with pending writes. Await waitForPendingWrites() before invoking toJSON().");let t={};t.type=n._jsonSchemaVersion,t.bundleSource="QuerySnapshot",t.bundleName=Qn.newId(),this._firestore._databaseId.database,this._firestore._databaseId.projectId;let e=[],r=[],s=[];return this.docs.forEach(o=>{o._document!==null&&(e.push(o._document),r.push(this._userDataWriter.convertObjectMap(o._document.data.value.mapValue.fields,"previous")),s.push(o.ref.path))}),t.bundle=(this._firestore,this.query._query,t.bundleName,"NOT SUPPORTED"),t}};function wg(n){switch(n){case 0:return"added";case 2:case 3:return"modified";case 1:return"removed";default:return j(61501,{type:n})}}tn._jsonSchemaVersion="firestore/querySnapshot/1.0",tn._jsonSchema={type:ct("string",tn._jsonSchemaVersion),bundleSource:ct("string","QuerySnapshot"),bundleName:ct("string"),bundle:ct("string")};var Es=class extends ya{constructor(t){super(),this.firestore=t}convertBytes(t){return new le(t)}convertReference(t){let e=this.convertDocumentKey(t,this.firestore._databaseId);return new _t(this.firestore,null,e)}};function nd(n,t){let e=$n(n.firestore,mn),r=ug(n),s=_g(n.converter,t);return vg(e,[dg(Wh(n.firestore),"addDoc",r._key,s,n.converter!==null,{}).toMutation(r._key,Ce.exists(!1))]).then(()=>r)}function rd(n,...t){var e,r,s;n=oe(n);let o={includeMetadataChanges:!1,source:"default"},a=0;typeof t[a]!="object"||Al(t[a])||(o=t[a++]);let u={includeMetadataChanges:o.includeMetadataChanges,source:o.source};if(Al(t[a])){let g=t[a];t[a]=(e=g.next)===null||e===void 0?void 0:e.bind(g),t[a+1]=(r=g.error)===null||r===void 0?void 0:r.bind(g),t[a+2]=(s=g.complete)===null||s===void 0?void 0:s.bind(g)}let h,d,m;if(n instanceof _t)d=$n(n.firestore,mn),m=Sa(n._key.path),h={next:g=>{t[a]&&t[a](Eg(d,n,g))},error:t[a+1],complete:t[a+2]};else{let g=$n(n,Me);d=$n(g.firestore,mn),m=g._query;let _=new Es(d);h={next:I=>{t[a]&&t[a](new tn(d,_,g,I))},error:t[a+1],complete:t[a+2]},yg(n._query)}return function(_,I,S,D){let x=new aa(D),P=new ta(I,x,S);return _.asyncQueue.enqueueAndForget(async()=>zp(await vl(_),P)),()=>{x.Ou(),_.asyncQueue.enqueueAndForget(async()=>$p(await vl(_),P))}}(Kh(d),m,u,h)}function vg(n,t){return function(r,s){let o=new Wt;return r.asyncQueue.enqueueAndForget(async()=>Yp(await ag(r),s,o)),o.promise}(Kh(n),t)}function Eg(n,t,e){let r=e.docs.get(t._key),s=new Es(n);return new Re(n,s,t._key,r,new Se(e.hasPendingWrites,e.fromCache),t.converter)}function sd(){return new da("serverTimestamp")}(function(t,e=!0){(function(s){pn=s})(Ru),Un(new $t("firestore",(r,{instanceIdentifier:s,options:o})=>{let a=r.getProvider("app").getImmediate(),u=new mn(new Vi(r.getProvider("auth-internal")),new Oi(a,r.getProvider("app-check-internal")),function(d,m){if(!Object.prototype.hasOwnProperty.apply(d.options,["projectId"]))throw new B(N.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new Jr(d.options.projectId,m)}(a,s),a);return o=Object.assign({useFetchStreams:e},o),u._setSettings(o),u},"PUBLIC").setMultipleInstances(!0)),ce(ku,Ou,t),ce(ku,Ou,"esm2017")})();var Tg={apiKey:"AIzaSyDRLWeYyRT4FLesoROh534jIMZizGpxKXs",authDomain:"wedding-60251.firebaseapp.com",projectId:"wedding-60251",storageBucket:"wedding-60251.firebasestorage.app",messagingSenderId:"513508231418",appId:"1:513508231418:web:3429524ac377389a6ea143",measurementId:"G-36N9QR2HK4"},Ig=wi(Tg),qa=Gh(Ig);function id(n){return n=n.trim().toLowerCase(),n.charAt(0).toUpperCase()+n.slice(1)}function od(){let n=document.getElementById("commentForm"),t=document.getElementById("commentList"),e=document.getElementById("template"),r=document.getElementById("name"),s=document.getElementById("message"),o=document.getElementById("presence"),a=document.getElementById("errorName"),u=document.getElementById("errorMessage"),h=document.getElementById("errorPresence"),d=document.getElementById("submitBtn"),m=d.querySelector("span"),g=document.getElementById("cancelReplyBtn"),_=null,I="";function S(){_=null,I="",s.placeholder="Tulis Ucapan dan Doa",g.classList.add("d-none"),o.classList.remove("d-none"),a.textContent="",u.textContent="",h.textContent=""}n.addEventListener("submit",async P=>{P.preventDefault(),console.log("Form submitted"),a.textContent="",u.textContent="",h.textContent="";let R=id(r.value),M=id(s.value),V=o.value.trim(),O=!0;if(R.length<2&&(a.innerHTML=`<p class="text-danger m-0">
            ...
            `,A.appendChild(Tt)}),t.appendChild(T)}),document.getElementById("hadirCount").textContent=`${R}`,document.getElementById("tidakHadirCount").textContent=`${M}`,document.getElementById("totalCount").textContent=`${v} Comments`})}document.addEventListener("DOMContentLoaded",()=>{od()});var bg=()=>window.confetti.shapeFromPath({path:"M167 72c19,-38 37,-56 75,-56 42,0 76,33 76,75 0,76 -76,151 -151,227 -76,-76 -151,-151 -151,-227 0,-42 33,-75 75,-75 38,0 57,18 76,56z",matrix:[.03333333333333333,0,0,.03333333333333333,-5.566666666666666,-5.533333333333333]}),ad=()=>{window.confetti&&window.confetti({origin:{y:1},zIndex:1057})};var cd=(n,t=50)=>{if(!window.confetti)return;let e=Date.now()+t,r=n.getBoundingClientRect(),s=Math.max(.3,Math.min(1,r.top/window.innerHeight+.2)),o=bg(),a=["#FF69B4","#FF1493"],u=()=>{a.forEach(h=>{window.confetti({particleCount:2,angle:60,spread:55,shapes:[o],origin:{x:r.left/window.innerWidth,y:s},zIndex:1057,colors:[h]}),window.confetti({particleCount:2,angle:120,spread:55,shapes:[o],origin:{x:r.right/window.innerWidth,y:s},zIndex:1057,colors:[h]})}),Date.now()<e&&requestAnimationFrame(u)};requestAnimationFrame(u)};var ud=(()=>{console.log("guest.js jalan");let n=null,t=null,e=()=>{let P=new Date(document.body.getAttribute("data-time").replace(" ","T")).getTime(),R=p=>p<10?`0${p}`:`${p}`,M=document.getElementById("day"),V=document.getElementById("hour"),O=document.getElementById("minute"),F=document.getElementById("second"),v=()=>{let p=Math.abs(P-Date.now());M.textContent=R(Math.floor(p/(1e3*60*60*24))),V.textContent=R(Math.floor(p%(1e3*60*60*24)/(1e3*60*60))),O.textContent=R(Math.floor(p%(1e3*60*60)/(1e3*60))),F.textContent=R(Math.floor(p%(1e3*60)/1e3)),X.timeOut(v,1e3-Date.now()%1e3)};X.timeOut(v)},r=()=>{let P=window.location.search.split("to="),R=null;if(P.length>1&&P[1].length>=1&&(R=window.decodeURIComponent(P[1])),R){let V=document.getElementById("guest-name"),O=document.createElement("div");O.classList.add("m-2");let F=`<small class="mt-0 mb-1 mx-0 p-0 fw-semibold" style="color: #fff;">${X.escapeHtml(V?.getAttribute("data-message"))}</small><p class="m-0 p-0" style="font-size: 1.25rem">${X.escapeHtml(R)}</p>`;X.safeInnerHTML(O,F),V?.appendChild(O)}let M=document.getElementById("form-name");M&&(M.value=n.get("name")??R)},s=async()=>{let R=document.querySelectorAll(".slide-desktop");if(!R||R.length===0)return;let M=document.getElementById("root")?.querySelector(".d-sm-block");if(!M||(M.dispatchEvent(new Event("undangan.slide.stop")),window.getComputedStyle(M).display==="none"))return;if(R.length===1){await X.changeOpacity(R[0],!0);return}let V=0;for(let[p,y]of R.entries())if(p===V){y.classList.add("slide-desktop-active"),await X.changeOpacity(y,!0);break}let O=!0,F=async()=>(await X.changeOpacity(R[V],!1),R[V].classList.remove("slide-desktop-active"),V=(V+1)%R.length,O&&(R[V].classList.add("slide-desktop-active"),await X.changeOpacity(R[V],!0)),O);M.addEventListener("undangan.slide.stop",()=>{O=!1});let v=async()=>{await F()&&X.timeOut(v,6e3)};X.timeOut(v,6e3)},o=P=>{P.disabled=!0,document.body.scrollIntoView({behavior:"instant"}),document.getElementById("root").classList.remove("opacity-0"),s(),xr.spyTop(),ad(),document.dispatchEvent(new Event("undangan.open")),X.changeOpacity(document.getElementById("welcome"),!1).then(R=>R.remove())},a=P=>{document.getElementById("button-modal-click").setAttribute("href",P.src),document.getElementById("button-modal-download").setAttribute("data-src",P.src);let R=document.getElementById("show-modal-image");R.src=P.src,R.width=P.width,R.height=P.height,Qc.modal("modal-image").show()},u=()=>{document.getElementById("show-modal-image").addEventListener("click",P=>{let R=P.currentTarget.parentNode.querySelector(".position-absolute");R.classList.contains("d-none")?R.classList.replace("d-none","d-flex"):R.classList.replace("d-flex","d-none")})},h=P=>{navigator.vibrate&&navigator.vibrate(500),cd(P,100),X.changeOpacity(P,!1).then(R=>R.remove())},d=()=>n.set("info",!0),m=()=>{document.querySelectorAll(".font-arabic").forEach(P=>{P.innerHTML=String(P.innerHTML).normalize("NFC")})},g=()=>{document.querySelectorAll("svg").forEach(P=>{P.hasAttribute("data-class")&&X.timeOut(()=>P.classList.add(P.getAttribute("data-class")),parseInt(P.getAttribute("data-time")))})},_=()=>{let P=V=>new Date(V.replace(" ","T")+":00Z").toISOString().replace(/[-:]/g,"").split(".").shift(),R=new URL("https://calendar.google.com/calendar/render"),M=new URLSearchParams({action:"TEMPLATE",text:"The Wedding of Wahyu and Riski",dates:`${P("2023-03-15 10:00")}/${P("2023-03-15 11:00")}`,details:"Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara pernikahan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.",location:"RT 10 RW 02, Desa Pajerukan, Kec. Kalibagor, Kab. Banyumas, Jawa Tengah 53191.",ctz:t.get("tz")});R.search=M.toString(),document.querySelector("#home button")?.addEventListener("click",()=>window.open(R,"_blank"))},I=()=>(K.add(),{load:R=>{Jc(R).then(()=>K.complete("libs")).catch(()=>K.invalid("libs"))}}),S=async()=>{g(),e(),r(),u(),m(),_(),n.has("presence")&&(document.getElementById("form-presence").value=n.get("presence")?"1":"2"),n.get("info")&&document.getElementById("information")?.remove(),await X.changeOpacity(document.getElementById("welcome"),!0),document.querySelector("#welcome .fade-up").classList.add("show"),await X.changeOpacity(document.getElementById("loading"),!1).then(P=>P.remove())},D=()=>{Xc.init(),Zc.init(),K.init(),t=bt("config"),n=bt("information");let P=Kc.init(),R=Hc.init(),M=Wc.init(),V=I(),O=document.body.getAttribute("data-key"),F=new URLSearchParams(window.location.search);if(window.addEventListener("resize",X.debounce(s)),document.addEventListener("undangan.progress.done",()=>S()),document.addEventListener("hide.bs.modal",()=>document.activeElement?.blur()),document.getElementById("button-modal-download").addEventListener("click",v=>{R.download(v.currentTarget.getAttribute("data-src"))}),(!O||O.length<=0)&&(document.getElementById("comment")?.remove(),document.querySelector('a.nav-link[href="#comment"]')?.closest("li.nav-item")?.remove(),P.load(),R.load(),M.load(),V.load({confetti:document.body.getAttribute("data-confetti")==="true"})),O&&O.length>0){K.add(),K.add(),R.hasDataSrc()||R.load();let v=()=>Pr.guest(F.get("k")??O).then(({data:p})=>{document.dispatchEvent(new Event("undangan.session")),K.complete("config"),R.hasDataSrc()&&R.load(),P.load(),M.load(),V.load({confetti:p.is_confetti_animation}),comment.show().then(()=>K.complete("comment")).catch(()=>K.invalid("comment"))}).catch(()=>K.invalid("config"));window.addEventListener("load",v)}};return{init:()=>(xr.init(),Pr.init(),Pr.isAdmin()&&(bt("user").clear(),bt("owns").clear(),bt("likes").clear(),bt("session").clear(),bt("comment").clear()),document.addEventListener("DOMContentLoaded",D),{util:X,theme:xr,guest:{open:o,modal:a,showStory:h,closeInformation:d}})}})();(n=>{n.undangan=ud.init()})(window);})();
